...
import org.eclipse.gmf.map.editor.edit.policies.TopNodeReferenceCanonicalEditPolicy;
import org.eclipse.gmf.map.editor.edit.policies.TopNodeReferenceItemSemanticEditPolicy;
 ...
 * @generated
 */
public class TopNodeReferenceEditPart extends ShapeNodeEditPart {
	 ...
	 * @generated
	 */
	public TopNodeReferenceEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new TopNodeReferenceItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE, new TopNodeReferenceCanonicalEditPolicy());
	...
	public ReferenceFigure getPrimaryShape() {
		return (ReferenceFigure) primaryShape;
	}
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ReferenceInfoEditPart) {
			((ReferenceInfoEditPart) childEditPart).setLabel(getPrimaryShape().getFigureReferenceInfoFigure());
			return true;
		}
		return false;
	}
	...
	protected NodeFigure createNodePlate() {
		DefaultSizeNodeFigure result = new DefaultSizeNodeFigure(getMapMode().DPtoLP(16), getMapMode().DPtoLP(8));
		return result;
	}
	...
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(GMFMapVisualIDRegistry.getType(ReferenceInfoEditPart.VISUAL_ID));
	}
	...
	public class ReferenceFigure extends org.eclipse.gmf.map.editor.figures.ReferenceFigure {
		...
		public ReferenceFigure() {
			...
			this.setBorder(new org.eclipse.draw2d.MarginBorder(getMapMode().DPtoLP(4), getMapMode().DPtoLP(0), getMapMode().DPtoLP(6), getMapMode().DPtoLP(0)));
