...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmf.codegen.gmfgen.GenRuleBase} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class GenRuleBaseItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_GenRuleBase_name_feature"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_GenRuleBase_type") :
			getString("_UI_GenRuleBase_type") + " " + label;
	}
