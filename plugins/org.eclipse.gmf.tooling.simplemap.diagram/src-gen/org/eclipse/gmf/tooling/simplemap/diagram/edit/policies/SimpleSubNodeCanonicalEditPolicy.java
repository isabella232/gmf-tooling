...
public class SimpleSubNodeCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<SimplemapNodeDescriptor> childDescriptors = SimplemapDiagramUpdater.getSimpleSubNode_2003SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<SimplemapNodeDescriptor> childDescriptors = SimplemapDiagramUpdater.getSimpleSubNode_2003SemanticChildren((View) getHost().getModel());
