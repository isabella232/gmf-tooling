 ...
 * @generated
 */
public class SimpleTopNodeCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		List<SimplemapNodeDescriptor> childDescriptors = SimplemapDiagramUpdater.getSimpleTopNode_1001SemanticChildren(viewObject);
	...
	protected void refreshSemantic() {
		...
		List<SimplemapNodeDescriptor> childDescriptors = SimplemapDiagramUpdater.getSimpleTopNode_1001SemanticChildren((View) getHost().getModel());
