 ...
 * @generated
 */
public class SimpleTopNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SimpleTopNodeNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplemapParserProvider.getParser(SimplemapElementTypes.SimpleTopNode_1001, getParserElement(),
					SimplemapVisualIDRegistry.getType(org.eclipse.gmf.tooling.simplemap.diagram.edit.parts.SimpleTopNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private RGBColor getFigureBackgroundColor() {
		Figure nodeFigure = ((SimpleTopNode) resolveSemanticElement()).getNodeFigure();
