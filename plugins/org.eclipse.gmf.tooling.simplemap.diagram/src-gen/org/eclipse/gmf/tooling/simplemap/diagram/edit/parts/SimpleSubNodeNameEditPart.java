 ...
 * @generated
 */
public class SimpleSubNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplemapParserProvider.getParser(SimplemapElementTypes.SimpleSubNode_2003, getParserElement(),
					SimplemapVisualIDRegistry.getType(org.eclipse.gmf.tooling.simplemap.diagram.edit.parts.SimpleSubNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private RGBColor getFigureBackgroundColor() {
		Figure nodeFigure = ((SimpleSubNode) resolveSemanticElement()).getNodeFigure();
