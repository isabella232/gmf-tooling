 ...
 * @generated
 */
public class SimpleCompartmentNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public SimpleCompartmentNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new SimplemapTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new SimpleMappingEditPart.NodeLabelDragPolicy());
	}
	...
	protected void setForegroundColorIconHelper(IFigure figure, RGBColor foreGroundColor) {
		if (figure instanceof WrappingLabelWithColorIcon) {
			((WrappingLabelWithColorIcon) figure).setForegroundColor(foreGroundColor);
		}
	}

	protected void setBackgroundColorIconHelper(IFigure figure, RGBColor backgroundColor) {
		if (figure instanceof WrappingLabelWithColorIcon) {
			((WrappingLabelWithColorIcon) figure).setBackgroundColor(backgroundColor);
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = SimplemapParserProvider.getParser(SimplemapElementTypes.SimpleCompartment_2002, getParserElement(),
					SimplemapVisualIDRegistry.getType(org.eclipse.gmf.tooling.simplemap.diagram.edit.parts.SimpleCompartmentNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	private RGBColor getFigureBackgroundColor() {
		Figure nodeFigure = ((SimpleCompartment) resolveSemanticElement()).getNodeFigure();
