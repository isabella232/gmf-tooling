...
import org.eclipse.gmf.tooling.simplemap.diagram.providers.ElementInitializers;
 ...
 * @generated
 */
public class SimplemapDiagramEditorPlugin extends AbstractUIPlugin {
	 ...
	 * @generated
	 */
	private static SimplemapDiagramEditorPlugin instance;
	 ...
	 * @generated
	 */
	private SimplemapDocumentProvider documentProvider;
	 ...
	 * @generated
	 */
	public static SimplemapDiagramEditorPlugin getInstance() {
		return instance;
	}
	 ...
	 * @generated
	 */
	public SimplemapDocumentProvider getDocumentProvider() {
	...
	public void logError(String error, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.ERROR, SimplemapDiagramEditorPlugin.ID, IStatus.OK, error, throwable));
	...
	public void logInfo(String message, Throwable throwable) {
		...
		getLog().log(new Status(IStatus.INFO, SimplemapDiagramEditorPlugin.ID, IStatus.OK, message, throwable));
