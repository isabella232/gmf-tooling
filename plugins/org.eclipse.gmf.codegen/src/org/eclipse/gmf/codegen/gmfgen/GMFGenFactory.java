...
public interface GMFGenFactory extends EFactory {
	...
	/**
	 * Returns a new object of class '<em>Gen Multi Faceted Node</em>'.
	 * <!-- begin-user-doc -->
	 * @since 2.111
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Gen Multi Faceted Node</em>'.
	 * @generated
	 */
	GenMultiFacetedNode createGenMultiFacetedNode();

	/**
	 * Returns a new object of class '<em>Type Node Model Facet</em>'.
	 * <!-- begin-user-doc -->
	 * @since 2.111
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Type Node Model Facet</em>'.
	 * @generated
	 */
	TypeNodeModelFacet createTypeNodeModelFacet();
