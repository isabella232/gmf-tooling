/**
 * Copyright (c) 2007, 2009, 2013 Borland Software Corporation
 * 
...
class PredefinedParser {
	...
	def additions(org.eclipse.gmf.codegen.gmfgen.PredefinedParser it) ''''''

	def fields(org.eclipse.gmf.codegen.gmfgen.PredefinedParser it) '''
	...
	def aux_methods(org.eclipse.gmf.codegen.gmfgen.PredefinedParser it) '''
	«IF viewMethod == LabelTextAccessMethod::MESSAGE_FORMAT»
	«generatedMemberComment»
	...
	def parser_getEditStringMethod(org.eclipse.gmf.codegen.gmfgen.PredefinedParser it) '''
		«generatedMemberComment»
	...
	def parser_isValidEditStringMethod(org.eclipse.gmf.codegen.gmfgen.PredefinedParser it) '''
		«generatedMemberComment»
	...
	def parser_getParseCommandMethod(org.eclipse.gmf.codegen.gmfgen.PredefinedParser it) '''
		«generatedMemberComment»
	...
	def parser_getPrintStringMethod(org.eclipse.gmf.codegen.gmfgen.PredefinedParser it) '''
		«generatedMemberComment»
	...
	def parser_isAffectingEventMethod(org.eclipse.gmf.codegen.gmfgen.PredefinedParser it) '''«/* NO-OP, rely on superclass for now */»'''
