 ...
 * <ul>
 *   <li>{@link org.eclipse.gmf.tooling.simplemap.simplemappings.SimpleNode#getTool <em>Tool</em>}</li>
 *   <li>{@link org.eclipse.gmf.tooling.simplemap.simplemappings.SimpleNode#getLabelAttributes <em>Label Attributes</em>}</li>
 *   <li>{@link org.eclipse.gmf.tooling.simplemap.simplemappings.SimpleNode#getDiagramNode <em>Diagram Node</em>}</li>
 *   <li>{@link org.eclipse.gmf.tooling.simplemap.simplemappings.SimpleNode#getDiagramLabel <em>Diagram Label</em>}</li>
 *   <li>{@link org.eclipse.gmf.tooling.simplemap.simplemappings.SimpleNode#getDomainMetaElement <em>Domain Meta Element</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.gmf.tooling.simplemap.simplemappings.SimplemappingsPackage#getSimpleNode()
 * @model
 * @generated
 */
public interface SimpleNode extends SimpleChildNode, SimpleMappingElementWithFigure, SimpleNodeReference {
	 ...
	 * @see #isSetTool()
	 * @see org.eclipse.gmf.tooling.simplemap.simplemappings.SimplemappingsPackage#getSimpleNode_Tool()
	...
	/**
	 * Returns whether the value of the '{@link org.eclipse.gmf.tooling.simplemap.simplemappings.SimpleNode#getTool <em>Tool</em>}' reference is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.gmf.tooling.simplemap.simplemappings.SimplemappingsPackage#getSimpleNode_LabelAttributes()
	 ...
	 * @see org.eclipse.gmf.tooling.simplemap.simplemappings.SimplemappingsPackage#getSimpleNode_DiagramNode()
	 * @model unsettable="true" changeable="false" derived="true"
	 * @generated
	 */
	Node getDiagramNode();
	...
	/**
	 * Returns whether the value of the '{@link org.eclipse.gmf.tooling.simplemap.simplemappings.SimpleNode#getDiagramNode <em>Diagram Node</em>}' reference is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.gmf.tooling.simplemap.simplemappings.SimplemappingsPackage#getSimpleNode_DiagramLabel()
	 * @model unsettable="true" changeable="false" derived="true"
	 * @generated
	 */
	...
	/**
	 * Returns whether the value of the '{@link org.eclipse.gmf.tooling.simplemap.simplemappings.SimpleNode#getDiagramLabel <em>Diagram Label</em>}' reference is set.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see org.eclipse.gmf.tooling.simplemap.simplemappings.SimplemappingsPackage#getSimpleNode_DomainMetaElement()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.gmf.tooling.simplemap.simplemappings.SimpleNode#getDomainMetaElement <em>Domain Meta Element</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
