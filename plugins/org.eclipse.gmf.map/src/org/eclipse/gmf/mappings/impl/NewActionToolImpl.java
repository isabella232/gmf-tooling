...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>New Action Tool</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 *   <li>{@link org.eclipse.gmf.mappings.impl.NewActionToolImpl#getGroup <em>Group</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class NewActionToolImpl extends EObjectImpl implements NewActionTool {
	/**
	...
	protected EClass eStaticClass() {
		return GMFMapPackage.eINSTANCE.getNewActionTool();
	}
	...
	public NotificationChain basicSetGroup(ToolGroup newGroup, NotificationChain msgs) {
		...
		group = newGroup;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, GMFMapPackage.NEW_ACTION_TOOL__GROUP, oldGroup, newGroup);
	...
	public void setGroup(ToolGroup newGroup) {
		if (newGroup != group) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, GMFMapPackage.NEW_ACTION_TOOL__GROUP, newGroup, newGroup));
	}
