...
public class LabelTextEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GMFGraphParserProvider.getParser(GMFGraphElementTypes.Label_3026, getParserElement(), GMFGraphVisualIDRegistry
					.getType(org.eclipse.gmf.graphdef.editor.edit.parts.LabelTextEditPart.VISUAL_ID));
		}
		return parser;
	}
