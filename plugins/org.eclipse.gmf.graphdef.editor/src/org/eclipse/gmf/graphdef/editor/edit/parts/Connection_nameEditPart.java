 ...
 * @generated
 */
public class Connection_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Connection_nameEditPart(View view) {
		super(view);
	}
				...
				ParserHintAdapter hintAdapter = new ParserHintAdapter(element, parserHint) {
					...
					public Object getAdapter(Class adapter) {
						if (IElementType.class.equals(adapter)) {
							return GMFGraphElementTypes.Connection_1003;
						}
