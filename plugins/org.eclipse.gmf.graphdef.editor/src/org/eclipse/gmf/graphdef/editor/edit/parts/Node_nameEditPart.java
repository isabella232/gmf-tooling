 ...
 * @generated
 */
public class Node_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Node_nameEditPart(View view) {
		super(view);
	}
				...
				ParserHintAdapter hintAdapter = new ParserHintAdapter(element, parserHint) {
					...
					public Object getAdapter(Class adapter) {
						if (IElementType.class.equals(adapter)) {
							return GMFGraphElementTypes.Node_1002;
						}
