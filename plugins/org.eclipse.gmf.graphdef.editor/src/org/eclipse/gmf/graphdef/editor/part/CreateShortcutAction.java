...
public class CreateShortcutAction extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		GMFGraphElementChooserDialog elementChooser = new GMFGraphElementChooserDialog(shell, view);
		...
		command = command.compose(new GMFGraphCreateShortcutDecorationsCommand(editingDomain, view, viewDescriptor));
		try {
