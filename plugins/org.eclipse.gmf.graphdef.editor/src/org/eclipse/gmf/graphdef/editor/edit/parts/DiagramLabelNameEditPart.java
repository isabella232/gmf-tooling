...
public class DiagramLabelNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GMFGraphParserProvider.getParser(GMFGraphElementTypes.DiagramLabel_2009, getParserElement(), GMFGraphVisualIDRegistry
					.getType(org.eclipse.gmf.graphdef.editor.edit.parts.DiagramLabelNameEditPart.VISUAL_ID));
		}
		return parser;
	}
