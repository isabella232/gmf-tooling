 ...
 * @generated
 */
public class Compartment_nameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public Compartment_nameEditPart(View view) {
		super(view);
	}
				...
				ParserHintAdapter hintAdapter = new ParserHintAdapter(element, parserHint) {
					...
					public Object getAdapter(Class adapter) {
						if (IElementType.class.equals(adapter)) {
							return GMFGraphElementTypes.Compartment_1001;
						}
	...
	protected IFigure createFigurePrim() {
		return new DiagramElementFigure_NameLabel();
	}
