...
public class FigureGalleryNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public FigureGalleryNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GMFGraphParserProvider.getParser(GMFGraphElementTypes.FigureGallery_2008, getParserElement(), GMFGraphVisualIDRegistry
					.getType(org.eclipse.gmf.graphdef.editor.edit.parts.FigureGalleryNameEditPart.VISUAL_ID));
		}
		return parser;
	}
