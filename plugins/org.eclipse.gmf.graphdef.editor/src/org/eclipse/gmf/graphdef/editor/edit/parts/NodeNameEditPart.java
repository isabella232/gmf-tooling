...
public class NodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GMFGraphParserProvider.getParser(GMFGraphElementTypes.Node_2006, getParserElement(), GMFGraphVisualIDRegistry
					.getType(org.eclipse.gmf.graphdef.editor.edit.parts.NodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
