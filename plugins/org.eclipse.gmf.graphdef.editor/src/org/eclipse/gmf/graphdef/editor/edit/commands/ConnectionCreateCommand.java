...
public class ConnectionCreateCommand extends EditElementCommand {
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		Connection newElement = GMFGraphFactory.eINSTANCE.createConnection();
	 ...
	 * @generated
	 */
	protected void doConfigure(Connection newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
