...
public class LabelText2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = GMFGraphParserProvider.getParser(GMFGraphElementTypes.Label_3027, getParserElement(), GMFGraphVisualIDRegistry
					.getType(org.eclipse.gmf.graphdef.editor.edit.parts.LabelText2EditPart.VISUAL_ID));
		}
		return parser;
	}
