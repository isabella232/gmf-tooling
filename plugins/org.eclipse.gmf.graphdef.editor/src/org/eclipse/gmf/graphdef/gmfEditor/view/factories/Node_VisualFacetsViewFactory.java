 ...
 * @generated
 */
public class Node_VisualFacetsViewFactory extends ListCompartmentViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = org.eclipse.gmf.graphdef.gmfEditor.edit.parts.Node_VisualFacetsEditPart.VISUAL_ID;
