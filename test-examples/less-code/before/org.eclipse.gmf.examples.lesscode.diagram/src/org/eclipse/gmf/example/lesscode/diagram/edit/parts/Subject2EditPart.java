...
import org.eclipse.gmf.example.lesscode.diagram.edit.policies.Subject2ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Subject2EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Subject2EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Subject2ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SubjectName2EditPart) {
			((SubjectName2EditPart) childEditPart).setLabel(getPrimaryShape().getFigureSubjectNameFigure());
			return true;
		}
		if (childEditPart instanceof SubjectInSubject2EditPart) {
			IFigure pane = getPrimaryShape().getFigureSubjectContentPaneFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((SubjectInSubject2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SubjectInSubject2EditPart) {
			IFigure pane = getPrimaryShape().getFigureSubjectContentPaneFigure();
			pane.remove(((SubjectInSubject2EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof SubjectInSubject2EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LesscodeVisualIDRegistry.getType(SubjectName2EditPart.VISUAL_ID));
	}
