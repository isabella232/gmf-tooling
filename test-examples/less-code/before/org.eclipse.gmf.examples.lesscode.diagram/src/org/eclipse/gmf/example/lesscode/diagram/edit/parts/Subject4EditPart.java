...
import org.eclipse.gmf.example.lesscode.diagram.edit.policies.Subject4ItemSemanticEditPolicy;
 ...
 * @generated
 */
public class Subject4EditPart extends ShapeNodeEditPart {
	...
	* @generated
	*/
	public Subject4EditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new Subject4ItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof SubjectName4EditPart) {
			((SubjectName4EditPart) childEditPart).setLabel(getPrimaryShape().getFigureSubjectNameFigure());
			return true;
		}
		if (childEditPart instanceof SubjectInSubject4EditPart) {
			IFigure pane = getPrimaryShape().getFigureSubjectContentPaneFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((SubjectInSubject4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof SubjectInSubject4EditPart) {
			IFigure pane = getPrimaryShape().getFigureSubjectContentPaneFigure();
			pane.remove(((SubjectInSubject4EditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof SubjectInSubject4EditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(LesscodeVisualIDRegistry.getType(SubjectName4EditPart.VISUAL_ID));
	}
