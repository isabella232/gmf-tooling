...
import org.eclipse.gmf.tooling.examples.affixednode.diagram.edit.policies.AffixednodeTextSelectionEditPolicy;
 ...
 * @generated
 */
public class BundleNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public BundleNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new AffixednodeTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return AffixednodeElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = AffixednodeParserProvider.getParser(AffixednodeElementTypes.Bundle_2001, getParserElement(),
					AffixednodeVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.affixednode.diagram.edit.parts.BundleNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null, AffixednodeEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
