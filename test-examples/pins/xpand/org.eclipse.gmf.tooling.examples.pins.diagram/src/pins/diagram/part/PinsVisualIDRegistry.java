...
public class PinsVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return pins.diagram.part.PinsVisualIDRegistry.getVisualID(view.getType());
	}
	...
	public static int getDiagramVisualID(EObject domainElement) {
		...
		if (PinsPackage.eINSTANCE.getDiagram().isSuperTypeOf(domainElement.eClass()) && isDiagram((pins.Diagram) domainElement)) {
			return DiagramEditPart.VISUAL_ID;
		}
		return -1;
	}
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		...
		String containerModelID = pins.diagram.part.PinsVisualIDRegistry.getModelID(containerView);
		if (!DiagramEditPart.MODEL_ID.equals(containerModelID)) {
			return -1;
		}
		int containerVisualID;
		if (DiagramEditPart.MODEL_ID.equals(containerModelID)) {
			containerVisualID = pins.diagram.part.PinsVisualIDRegistry.getVisualID(containerView);
		} else {
	 ...
	 * @generated
	 */
	private static boolean isDiagram(pins.Diagram element) {
		return true;
	}
	...
	public static final DiagramStructure TYPED_INSTANCE = new DiagramStructure() {
		...
		public int getVisualID(View view) {
			return pins.diagram.part.PinsVisualIDRegistry.getVisualID(view);
		}
		...
		public String getModelID(View view) {
			return pins.diagram.part.PinsVisualIDRegistry.getModelID(view);
		}
		...
		public int getNodeVisualID(View containerView, EObject domainElement) {
			return pins.diagram.part.PinsVisualIDRegistry.getNodeVisualID(containerView, domainElement);
		}
		...
		public boolean checkNodeVisualID(View containerView, EObject domainElement, int candidate) {
			return pins.diagram.part.PinsVisualIDRegistry.checkNodeVisualID(containerView, domainElement, candidate);
		}
		...
		public boolean isCompartmentVisualID(int visualID) {
			return pins.diagram.part.PinsVisualIDRegistry.isCompartmentVisualID(visualID);
		}
		...
		public boolean isSemanticLeafVisualID(int visualID) {
			return pins.diagram.part.PinsVisualIDRegistry.isSemanticLeafVisualID(visualID);
		}
	};
