...
public class VisiblePinWarningLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PinsParserProvider.getParser(PinsElementTypes.VisiblePin_2002, getParserElement(), PinsVisualIDRegistry.getType(pins.diagram.edit.parts.VisiblePinWarningLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
