...
import org.eclipse.gmf.tooling.examples.pins.diagram.edit.commands.PinsChild2CreateCommand;
 ...
 * @generated
 */
public class VisiblePinItemSemanticEditPolicy extends PinsBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public VisiblePinItemSemanticEditPolicy() {
		super(PinsElementTypes.VisiblePin_2002);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PinsElementTypes.PinsChild_3002 == req.getElementType()) {
			return getGEFWrapper(new PinsChild2CreateCommand(req));
		}
