...
public class PinsNavigatorLabelProvider extends LabelProvider implements ICommonLabelProvider, ITreePathLabelProvider {
	...
	*/
	public Image getImage(View view) {
		...
		case ChangeableColorPinEditPart.VISUAL_ID:
			return getImage("Navigator?TopLevelNode?http://org.eclipse.gmf.tooling.examples.pins?ChangeableColorPin", PinsElementTypes.ChangeableColorPin_2004); //$NON-NLS-1$
	...
	*/
	public String getText(View view) {
		...
		case ChangeableColorPinEditPart.VISUAL_ID:
			return getChangeableColorPin_2004Text(view);
		case PinsChildEditPart.VISUAL_ID:
	...
	* @generated
	*/
	private String getChangeableColorPin_2004Text(View view) {
		IParser parser = PinsParserProvider.getParser(PinsElementTypes.ChangeableColorPin_2004, view.getElement() != null ? view.getElement() : view,
				PinsVisualIDRegistry.getType(ChangeableColorPinRedEditPart.VISUAL_ID));
		if (parser != null) {
			return parser.getPrintString(new EObjectAdapter(view.getElement() != null ? view.getElement() : view), ParserOptions.NONE.intValue());
		} else {
			PinsDiagramEditorPlugin.getInstance().logError("Parser was not found for label " + 5002); //$NON-NLS-1$
			return ""; //$NON-NLS-1$
		}
	}
