...
import org.eclipse.gmf.tooling.examples.pins.diagram.edit.commands.PinsChildCreateCommand;
 ...
 * @generated
 */
public class CustomPinItemSemanticEditPolicy extends PinsBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public CustomPinItemSemanticEditPolicy() {
		super(PinsElementTypes.CustomPin_2001);
	}
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		if (PinsElementTypes.PinsChild_3001 == req.getElementType()) {
			return getGEFWrapper(new PinsChildCreateCommand(req));
		}
