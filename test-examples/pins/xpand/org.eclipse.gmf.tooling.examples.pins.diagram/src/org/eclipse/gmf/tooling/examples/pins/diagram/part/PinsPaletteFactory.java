...
public class PinsPaletteFactory {
	...
	*/
	private PaletteContainer createPins1Group() {
		...
		paletteContainer.add(createChangeableColorPin5CreationTool());
	...
	* @generated
	*/
	private ToolEntry createChangeableColorPin5CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(Messages.ChangeableColorPin5CreationTool_title, Messages.ChangeableColorPin5CreationTool_desc,
				Collections.singletonList(PinsElementTypes.ChangeableColorPin_2004));
		entry.setId("createChangeableColorPin5CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(PinsElementTypes.getImageDescriptor(PinsElementTypes.ChangeableColorPin_2004));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
