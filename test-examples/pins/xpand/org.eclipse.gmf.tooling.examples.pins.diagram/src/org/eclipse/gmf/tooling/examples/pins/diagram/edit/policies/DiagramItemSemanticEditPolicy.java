...
import org.eclipse.gmf.tooling.examples.pins.diagram.edit.commands.ChangeableColorPinCreateCommand;
import org.eclipse.gmf.tooling.examples.pins.diagram.edit.commands.ColorPinCreateCommand;
import org.eclipse.gmf.tooling.examples.pins.diagram.edit.commands.CustomPinCreateCommand;
import org.eclipse.gmf.tooling.examples.pins.diagram.edit.commands.VisiblePinCreateCommand;
...
public class DiagramItemSemanticEditPolicy extends PinsBaseItemSemanticEditPolicy {
	...
	*/
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (PinsElementTypes.ChangeableColorPin_2004 == req.getElementType()) {
			return getGEFWrapper(new ChangeableColorPinCreateCommand(req));
		}
