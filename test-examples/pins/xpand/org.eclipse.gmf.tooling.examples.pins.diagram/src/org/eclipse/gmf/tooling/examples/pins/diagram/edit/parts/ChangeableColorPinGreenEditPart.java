...
import org.eclipse.gmf.tooling.examples.pins.diagram.providers.PinsParserProvider;
 ...
 * @generated
 */
public class ChangeableColorPinGreenEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ChangeableColorPinGreenEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new PinsTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return PinsElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PinsParserProvider.getParser(PinsElementTypes.ChangeableColorPin_2004, getParserElement(),
					PinsVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.pins.diagram.edit.parts.ChangeableColorPinGreenEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null, PinsEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
