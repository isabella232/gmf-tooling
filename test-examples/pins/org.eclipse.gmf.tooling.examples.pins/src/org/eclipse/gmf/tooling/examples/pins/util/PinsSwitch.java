 ...
 * @generated
 */
public class PinsSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case PinsPackage.PIN: {
				Pin pin = (Pin)theEObject;
				T result = casePin(pin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PinsPackage.COLOR_PIN: {
			...
			case PinsPackage.DIAGRAM: {
				Diagram diagram = (Diagram)theEObject;
				T result = caseDiagram(diagram);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PinsPackage.PINS_CHILD: {
				PinsChild pinsChild = (PinsChild)theEObject;
				T result = casePinsChild(pinsChild);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case PinsPackage.CHANGEABLE_COLOR_PIN: {
				ChangeableColorPin changeableColorPin = (ChangeableColorPin)theEObject;
				T result = caseChangeableColorPin(changeableColorPin);
				if (result == null) result = casePin(changeableColorPin);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T casePinsChild(PinsChild object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Changeable Color Pin</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Changeable Color Pin</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseChangeableColorPin(ChangeableColorPin object) {
		return null;
	}
