 ...
 * @generated
 */
public class VisiblePinWarningLabelEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public VisiblePinWarningLabelEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PinsParserProvider.getParser(PinsElementTypes.VisiblePin_2002, getParserElement(),
					PinsVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.pins.diagram.edit.parts.VisiblePinWarningLabelEditPart.VISUAL_ID));
		}
		return parser;
	}
