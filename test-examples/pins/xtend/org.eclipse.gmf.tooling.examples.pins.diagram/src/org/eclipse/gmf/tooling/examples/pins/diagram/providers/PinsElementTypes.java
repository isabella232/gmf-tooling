...
public class PinsElementTypes {
	 ...
	 * @generated
	 */
	public static final IElementType ChangeableColorPin_2004 = getElementType("org.eclipse.gmf.tooling.examples.pins.diagram.ChangeableColorPin_2004"); //$NON-NLS-1$
	...
	public static ENamedElement getElement(IAdaptable hint) {
		...
		if (elements == null) {
			...
			elements.put(ChangeableColorPin_2004, PinsPackage.eINSTANCE.getChangeableColorPin());
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(ChangeableColorPin_2004);
	...
	public static IElementType getElementType(int visualID) {
		...
		case ChangeableColorPinEditPart.VISUAL_ID:
			return ChangeableColorPin_2004;
	...
	public static final DiagramElementTypes TYPED_INSTANCE = new DiagramElementTypes(elementTypeImages) {
		...
		public boolean isKnownElementType(IElementType elementType) {
			return org.eclipse.gmf.tooling.examples.pins.diagram.providers.PinsElementTypes.isKnownElementType(elementType);
		}
		...
		public IElementType getElementTypeForVisualId(int visualID) {
			return org.eclipse.gmf.tooling.examples.pins.diagram.providers.PinsElementTypes.getElementType(visualID);
		}
		...
		public ENamedElement getDefiningNamedElement(IAdaptable elementTypeAdapter) {
			return org.eclipse.gmf.tooling.examples.pins.diagram.providers.PinsElementTypes.getElement(elementTypeAdapter);
		}
	};
