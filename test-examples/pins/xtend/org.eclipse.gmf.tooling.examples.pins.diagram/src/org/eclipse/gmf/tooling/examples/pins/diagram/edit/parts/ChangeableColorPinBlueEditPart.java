 ...
 * @generated
 */
public class ChangeableColorPinBlueEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ChangeableColorPinBlueEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PinsParserProvider.getParser(PinsElementTypes.ChangeableColorPin_2004, getParserElement(),
					PinsVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.pins.diagram.edit.parts.ChangeableColorPinBlueEditPart.VISUAL_ID));
		}
		return parser;
	}
