 ...
 * @generated
 */
public class ChangeableColorPinRedEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ChangeableColorPinRedEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = PinsParserProvider.getParser(PinsElementTypes.ChangeableColorPin_2004, getParserElement(),
					PinsVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.pins.diagram.edit.parts.ChangeableColorPinRedEditPart.VISUAL_ID));
		}
		return parser;
	}
