...
public class BordersPaletteFactory {
	...
	private ToolEntry createLineBorder1CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.LineBorder1CreationTool_title,
				Messages.LineBorder1CreationTool_desc,
				Collections.singletonList(BordersElementTypes.LineBorder_2004));
		entry.setId("createLineBorder1CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(BordersElementTypes
				.getImageDescriptor(BordersElementTypes.LineBorder_2004));
	...
	private ToolEntry createMarginBorder2CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.MarginBorder2CreationTool_title,
				Messages.MarginBorder2CreationTool_desc,
				Collections
						.singletonList(BordersElementTypes.MarginBorder_2001));
		entry.setId("createMarginBorder2CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(BordersElementTypes
				.getImageDescriptor(BordersElementTypes.MarginBorder_2001));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCompoundBorder3CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.CompoundBorder3CreationTool_title,
				Messages.CompoundBorder3CreationTool_desc,
				Collections
						.singletonList(BordersElementTypes.CompoundBorder_2003));
		entry.setId("createCompoundBorder3CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(BordersElementTypes
				.getImageDescriptor(BordersElementTypes.CompoundBorder_2003));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
	...
	private ToolEntry createCustomBorder4CreationTool() {
		NodeToolEntry entry = new NodeToolEntry(
				Messages.CustomBorder4CreationTool_title,
				Messages.CustomBorder4CreationTool_desc,
				Collections
						.singletonList(BordersElementTypes.CustomBorder_2002));
		entry.setId("createCustomBorder4CreationTool"); //$NON-NLS-1$
		entry.setSmallIcon(BordersElementTypes
				.getImageDescriptor(BordersElementTypes.CustomBorder_2002));
		entry.setLargeIcon(entry.getSmallIcon());
		return entry;
	}
