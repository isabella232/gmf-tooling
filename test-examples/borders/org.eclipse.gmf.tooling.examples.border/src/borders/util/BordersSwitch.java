 ...
 * @generated
 */
public class BordersSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case BordersPackage.MARGIN_BORDER: {
			...
			case BordersPackage.COMPOUND_BORDER: {
			...
			case BordersPackage.CUSTOM_BORDER: {
