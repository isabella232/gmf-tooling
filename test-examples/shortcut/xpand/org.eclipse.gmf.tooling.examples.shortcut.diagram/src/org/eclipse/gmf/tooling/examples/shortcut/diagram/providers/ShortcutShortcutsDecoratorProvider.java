...
* @generated
*/
public class ShortcutShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && DiagramEditPart.MODEL_ID.equals(ShortcutVisualIDRegistry.getModelID(view));
	}
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = ShortcutDiagramEditorPlugin.getInstance().getBundledImage("icons/shortcut.gif"); //$NON-NLS-1$
