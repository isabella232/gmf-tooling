 ...
 * @generated
 */
public class DiagramLinkCreateCommand extends EditElementCommand {
	...
	* @generated
	*/
	public DiagramLinkCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	*/
	public boolean canExecute() {
		...
		return ShortcutBaseItemSemanticEditPolicy.getLinkConstraints().canCreateDiagramLink_4001(getContainer(), getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		DiagramLink newElement = ShortcutFactory.eINSTANCE.createDiagramLink();
	...
	* @generated
	*/
	protected void doConfigure(DiagramLink newElement, IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
