/**
 */
package org.eclipse.gmf.tooling.examples.shortcut.provider;
...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmf.tooling.examples.shortcut.Diagram} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DiagramItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diagram_containsShortcutsTo_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diagram_containsShortcutsTo_feature", "_UI_Diagram_type"),
				 ShortcutPackage.Literals.DIAGRAM__CONTAINS_SHORTCUTS_TO,
				 true,
				 false,
				 false,
	...
	protected void addShortcutsProvidedForPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Diagram_shortcutsProvidedFor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Diagram_shortcutsProvidedFor_feature", "_UI_Diagram_type"),
				 ShortcutPackage.Literals.DIAGRAM__SHORTCUTS_PROVIDED_FOR,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShortcutPackage.Literals.DIAGRAM__LINKS);
			childrenFeatures.add(ShortcutPackage.Literals.DIAGRAM__NODES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ShortcutPackage.Literals.DIAGRAM__LINKS,
				 ShortcutFactory.eINSTANCE.createDiagramLink()));

		newChildDescriptors.add
			(createChildParameter
				(ShortcutPackage.Literals.DIAGRAM__NODES,
				 ShortcutFactory.eINSTANCE.createDiagramNode()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return ShortcutEditPlugin.INSTANCE;
	}
