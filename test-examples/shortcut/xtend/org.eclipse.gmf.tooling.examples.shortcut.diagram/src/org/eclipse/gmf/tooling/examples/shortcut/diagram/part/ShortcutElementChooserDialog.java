 ...
 * @generated
 */
public class ShortcutElementChooserDialog extends Dialog {
	 ...
	 * @generated
	 */
	public ShortcutElementChooserDialog(Shell parentShell, View view) {
		super(parentShell);
	...
	protected Control createDialogArea(Composite parent) {
		...
		getShell().setText(Messages.ShortcutElementChooserDialog_SelectModelElementTitle);
	...
	private boolean isValidModelFile(IFile file) {
		...
		return "shortcut".equals(fileExtension); //$NON-NLS-1$
	}
	...
	private class ModelElementsTreeContentProvider implements ITreeContentProvider {
		 ...
		 * @generated
		 */
		private AdapterFactoryContentProvider myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(ShortcutDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
		...
		public Object[] getChildren(Object parentElement) {
			...
			if (parentElement instanceof IFile) {
				...
				try {
					...
					ShortcutDiagramEditorPlugin.getInstance().logError("Unable to load resource: " + resourcePath.toString(), e); //$NON-NLS-1$
				}
	...
	private class ModelElementsTreeLabelProvider implements ILabelProvider {
		 ...
		 * @generated
		 */
		private AdapterFactoryLabelProvider myAdapterFactoryLabelProvider = new AdapterFactoryLabelProvider(ShortcutDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
				...
				if (selection.size() == 1) {
					...
					if (selectedElement instanceof EObject) {
						...
						setOkButtonEnabled(ViewService.getInstance().provides(Node.class, new EObjectAdapter(selectedModelElement), myView, null, ViewUtil.APPEND, true,
								ShortcutDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT));
