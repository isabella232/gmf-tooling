...
import org.eclipse.gmf.tooling.examples.shortcut.diagram.edit.policies.ShortcutTextSelectionEditPolicy;
 ...
 * @generated
 */
public class DiagramNodeNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public DiagramNodeNameEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new ShortcutTextSelectionEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return ShortcutElementTypes.getImage(parserElement.eClass());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ShortcutParserProvider.getParser(ShortcutElementTypes.DiagramNode_2001, getParserElement(),
					ShortcutVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.shortcut.diagram.edit.parts.DiagramNodeNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null, ShortcutEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
