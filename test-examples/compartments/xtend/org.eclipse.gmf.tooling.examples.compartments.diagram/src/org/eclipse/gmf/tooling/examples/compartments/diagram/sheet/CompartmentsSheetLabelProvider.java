package org.eclipse.gmf.tooling.examples.compartments.diagram.sheet;

import org.eclipse.core.runtime.IAdaptable;
import org.eclipse.gmf.runtime.emf.type.core.IElementType;
import org.eclipse.gmf.runtime.notation.View;
import org.eclipse.gmf.tooling.examples.compartments.diagram.navigator.CompartmentsNavigatorGroup;
...
public class CompartmentsSheetLabelProvider extends BaseLabelProvider implements ILabelProvider {
	...
	public String getText(Object element) {
		...
		if (element instanceof CompartmentsNavigatorGroup) {
			return ((CompartmentsNavigatorGroup) element).getGroupName();
		}
	...
	private IElementType getElementType(View view) {
		...
		while (view != null) {
			int vid = CompartmentsVisualIDRegistry.getVisualID(view);
			IElementType etype = CompartmentsElementTypes.getElementType(vid);
			if (etype != null) {
				return etype;
			}
