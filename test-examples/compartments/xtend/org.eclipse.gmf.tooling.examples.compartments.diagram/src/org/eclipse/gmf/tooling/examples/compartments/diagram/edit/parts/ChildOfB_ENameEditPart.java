 ...
 * @generated
 */
public class ChildOfB_ENameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ChildOfB_ENameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CompartmentsParserProvider.getParser(CompartmentsElementTypes.ChildOfB_E_3003, getParserElement(),
					CompartmentsVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.compartments.diagram.edit.parts.ChildOfB_ENameEditPart.VISUAL_ID));
		}
		return parser;
	}
