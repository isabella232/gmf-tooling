 ...
 * @generated
 */
public class ChildOfB_GNumberEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public ChildOfB_GNumberEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CompartmentsParserProvider.getParser(CompartmentsElementTypes.ChildOfB_G_3004, getParserElement(),
					CompartmentsVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.compartments.diagram.edit.parts.ChildOfB_GNumberEditPart.VISUAL_ID));
		}
		return parser;
	}
