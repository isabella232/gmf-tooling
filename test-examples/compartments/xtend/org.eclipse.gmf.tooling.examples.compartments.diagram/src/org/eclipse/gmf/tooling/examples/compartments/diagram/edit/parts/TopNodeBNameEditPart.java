 ...
 * @generated
 */
public class TopNodeBNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public TopNodeBNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = CompartmentsParserProvider.getParser(CompartmentsElementTypes.TopNodeB_2002, getParserElement(),
					CompartmentsVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.compartments.diagram.edit.parts.TopNodeBNameEditPart.VISUAL_ID));
		}
		return parser;
	}
