...
import org.eclipse.gmf.tooling.examples.compartments.diagram.edit.commands.ChildOfB_FDNodeRelationCreateCommand;
import org.eclipse.gmf.tooling.examples.compartments.diagram.edit.commands.ChildOfB_FDNodeRelationReorientCommand;
 ...
 * @generated
 */
public class ChildOfB_FItemSemanticEditPolicy extends CompartmentsBaseItemSemanticEditPolicy {

	/**
	 * @generated
	 */
	public ChildOfB_FItemSemanticEditPolicy() {
		super(CompartmentsElementTypes.ChildOfB_F_3006);
	}
	...
	protected Command getStartCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (CompartmentsElementTypes.ChildOfB_FDNodeRelation_4002 == req.getElementType()) {
			return getGEFWrapper(new ChildOfB_FDNodeRelationCreateCommand(req, req.getSource(), req.getTarget()));
		}
		return null;
	}
	...
	protected Command getReorientReferenceRelationshipCommand(ReorientReferenceRelationshipRequest req) {
		...
		case ChildOfB_FDNodeRelationEditPart.VISUAL_ID:
			return getGEFWrapper(new ChildOfB_FDNodeRelationReorientCommand(req));
		}
