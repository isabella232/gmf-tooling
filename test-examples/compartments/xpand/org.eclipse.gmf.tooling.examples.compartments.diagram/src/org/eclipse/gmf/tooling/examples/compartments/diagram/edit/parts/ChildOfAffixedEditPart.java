...
import org.eclipse.gmf.tooling.examples.compartments.diagram.edit.policies.ChildOfAffixedItemSemanticEditPolicy;
import org.eclipse.gmf.tooling.examples.compartments.diagram.edit.policies.CompartmentsTextNonResizableEditPolicy;
 ...
 * @generated
 */
public class ChildOfAffixedEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ChildOfAffixedEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ChildOfAffixedItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new CompartmentsTextNonResizableEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return CompartmentsElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CompartmentsParserProvider.getParser(CompartmentsElementTypes.ChildOfAffixed_3005, getParserElement(),
					CompartmentsVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.compartments.diagram.edit.parts.ChildOfAffixedEditPart.VISUAL_ID));
		}
		return parser;
	}
