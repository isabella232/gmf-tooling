 ...
 * @generated
 */
public class ChildOfA_CNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ChildOfA_CNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = CompartmentsParserProvider.getParser(CompartmentsElementTypes.ChildOfA_C_3001, getParserElement(),
					CompartmentsVisualIDRegistry.getType(org.eclipse.gmf.tooling.examples.compartments.diagram.edit.parts.ChildOfA_CNameEditPart.VISUAL_ID));
		}
		return parser;
	}
