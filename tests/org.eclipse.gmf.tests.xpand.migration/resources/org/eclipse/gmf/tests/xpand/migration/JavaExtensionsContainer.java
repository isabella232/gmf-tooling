...
public static String[] simpleNativeExtension(String parameter, Boolean parameter2) { return new String[] {"oclstdlib::OclVoid", "oclstdlib::String", "oclstdlib::Boolean", "oclstdlib::String"}; }
public static String[] simpleNativePolyExtension(String parameter, Boolean parameter2) { return new String[] {"oclstdlib::String", "oclstdlib::Boolean", "oclstdlib::String"}; }
public static String[] simpleNativePolyExtension(Object parameter, Boolean parameter2) { return new String[] {"oclstdlib::OclAny", "oclstdlib::Boolean", "oclstdlib::String"}; }
