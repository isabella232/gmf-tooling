...
public static String[] simpleNativeExtension() { return new String[] {"String", "String"}; }
public static String[] modelElementAsNativeExtensionParameter() { return new String[] {"ecore::EClass", "ecore::EObject", "ecore::EPackage"}; }
public static String[] collectionsInNativeExtensions() { return new String[] {"Sequence(ecore::EClass)", "Collection(ecore::EObject)", "Set(ecore::EPackage)", "Sequence(OclAny)", "Sequence(ecore::EClassifier)"}; }
}
