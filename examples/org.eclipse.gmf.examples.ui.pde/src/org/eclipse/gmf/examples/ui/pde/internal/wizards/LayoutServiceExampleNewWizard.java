...
public class LayoutServiceExampleNewWizard
    extends ProjectUnzipperNewWizard {

    /**
     * Constructor
     */
    public LayoutServiceExampleNewWizard() {
        super(
            "LayoutServiceExampleNewWizard", //$NON-NLS-1$
            Messages.LayoutServiceExample_createProjectPage_title,
            Messages.LayoutServiceExample_createProjectPage_desc,
            "org.eclipse.gmf.examples.runtime.diagram.layout", //$NON-NLS-1$  
            FileLocator.find(GmfExamplesPlugin.getDefault().getBundle(),
                new Path("examples/servicesLayout.zip"), null)); //$NON-NLS-1$
    }
}
