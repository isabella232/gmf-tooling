 ...
 * @generated
 */
public class RelationshipLabel2EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(
				MindmapVisualIDRegistry
						.getType(org.eclipse.gmf.examples.mindmap.rcp.diagram.edit.parts.RelationshipLabel2EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new MindmapParserProvider.HintAdapter(
					MindmapElementTypes.Relationship_4003, getParserElement(),
					parserHint);
