...
import org.eclipse.gmf.examples.mindmap.rcp.diagram.edit.policies.MindmapBaseItemSemanticEditPolicy;
...
public class TopicSubtopicsReorientCommand extends EditElementCommand {
	...
	protected boolean canReorientSource() {
		...
		return MindmapBaseItemSemanticEditPolicy.LinkConstraints
				.canExistTopicSubtopics_4001(getNewSource(), getOldTarget());
	}
	...
	protected boolean canReorientTarget() {
		...
		return MindmapBaseItemSemanticEditPolicy.LinkConstraints
				.canExistTopicSubtopics_4001(getOldSource(), getNewTarget());
	}
