...
public interface LesscodePackage extends EPackage {
	 ...
	 * @ordered
	 */
	int ROOT_CONTAINER_FEATURE_COUNT = 3;
	 ...
	 * @ordered
	 */
	int SUBJECT_FEATURE_COUNT = WITH_SOME_ATTRIBUTES_FEATURE_COUNT + 1;
