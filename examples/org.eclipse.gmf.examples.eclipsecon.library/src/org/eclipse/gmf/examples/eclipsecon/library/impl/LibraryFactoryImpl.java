 ...
 * </copyright>
 *
 * $Id: LibraryFactoryImpl.java,v 1.2 2007/02/22 21:48:18 ahunter Exp $
 */
...
public class LibraryFactoryImpl extends EFactoryImpl implements LibraryFactory {
	...
	public static LibraryFactory init() {
        try {
            LibraryFactory theLibraryFactory = (LibraryFactory)EPackage.Registry.INSTANCE.getEFactory("http:///org/eclipse/gmf/examples/library.ecore"); 
	...
	public EObject create(EClass eClass) {
        switch (eClass.getClassifierID()) {
            ...
            case LibraryPackage.EMPLOYEE: return createEmployee();
            case LibraryPackage.LIBRARY: return createLibrary();
            case LibraryPackage.SHELF: return createShelf();
            default:
