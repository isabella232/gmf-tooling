 ...
 * </copyright>
 *
 * $Id: LibraryPackageImpl.java,v 1.2 2007/02/22 21:48:18 ahunter Exp $
 */
...
public class LibraryPackageImpl extends EPackageImpl implements LibraryPackage {
     ...
     * @see org.eclipse.gmf.examples.eclipsecon.library.LibraryPackage#eNS_URI
     * @see #init()
     * @generated
     */
     ...
     * @generated
     */
	public EReference getEmployee_Shelves() {
     ...
     * @generated
     */
	public EReference getLibrary_Shelves() {
     ...
     * @generated
     */
	public EReference getShelf_Books() {
	...
	public void createPackageContents() {
        ...
        createEReference(employeeEClass, EMPLOYEE__SHELVES);

        libraryEClass = createEClass(LIBRARY);
        createEReference(libraryEClass, LIBRARY__SHELVES);
        ...
        createEReference(shelfEClass, SHELF__BOOKS);
    }
	...
	public void initializePackageContents() {
        ...
        initEReference(getAuthor_Books(), this.getBook(), this.getBook_Author(), "books", null, 0, -1, Author.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getBook_Author(), this.getAuthor(), this.getAuthor_Books(), "author", null, 1, 1, Book.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getEmployee_Shelves(), this.getShelf(), null, "shelves", null, 0, -1, Employee.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

        initEClass(libraryEClass, Library.class, "Library", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
        initEReference(getLibrary_Shelves(), this.getShelf(), null, "shelves", null, 0, -1, Library.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
        ...
        initEReference(getShelf_Books(), this.getBook(), null, "books", null, 0, -1, Shelf.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
