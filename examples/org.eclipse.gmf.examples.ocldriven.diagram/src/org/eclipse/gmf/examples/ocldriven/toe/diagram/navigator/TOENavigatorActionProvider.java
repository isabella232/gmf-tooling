...
import org.eclipse.gmf.examples.ocldriven.toe.diagram.part.TOEDiagramEditor;
...
* @generated
*/
public class TOENavigatorActionProvider extends CommonActionProvider {
	...
	private static class OpenDiagramAction extends Action {
		...
		*/
		public void run() {
			...
			try {
				page.openEditor(editorInput, TOEDiagramEditor.ID);
			} catch (PartInitException e) {
				TOEDiagramEditorPlugin.getInstance().logError("Exception while openning diagram", e); //$NON-NLS-1$
			}
		}
