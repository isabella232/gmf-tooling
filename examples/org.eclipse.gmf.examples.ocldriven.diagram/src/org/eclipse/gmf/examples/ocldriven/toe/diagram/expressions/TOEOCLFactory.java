package org.eclipse.gmf.examples.ocldriven.toe.diagram.expressions;
 ...
 * @generated
 */
public class TOEOCLFactory {

	/**
	* @generated
	*/
	private final TOEAbstractExpression[] expressions;
	...
	* @generated
	*/
	private static TOEOCLFactory getInstance() {
		TOEOCLFactory instance = TOEDiagramEditorPlugin.getInstance().getTOEOCLFactory();
		if (instance == null) {
			TOEDiagramEditorPlugin.getInstance().setTOEOCLFactory(instance = new TOEOCLFactory());
		}
		return instance;
	}
	...
	* @generated
	*/
	public static TOEAbstractExpression getExpression(int index, EClassifier context, Map<String, EClassifier> environment) {
		TOEOCLFactory cached = getInstance();
	...
	* @generated
	*/
	public static TOEAbstractExpression getExpression(String body, EClassifier context, Map<String, EClassifier> environment) {
	...
	* @generated
	*/
	public static TOEAbstractExpression getExpression(String body, EClassifier context) {
	...
	* @generated
	*/
	private static class Expression extends TOEAbstractExpression {
