...
public class BuildingItemSemanticEditPolicy extends TaiPanBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = allEdges.iterator(); it.hasNext();) {
			...
			EditCommandRequestWrapper editCommandRequest = new EditCommandRequestWrapper(new DestroyElementRequest(((BuildingEditPart) getHost()).getEditingDomain(), req.isConfirmationRequired()),
