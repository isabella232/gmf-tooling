...
public class TaiPanElementTypes extends ElementInitializers {
	 ...
	 * @generated
	 */
	public static final IElementType Building_2001 = getElementType("org.eclipse.gmf.examples.taipan.port.diagram.rcp.Building_2001"); //$NON-NLS-1$
	...
	private static ImageDescriptor getProvidedImageDescriptor(ENamedElement element) {
		...
		if (element instanceof EClass) {
			...
			if (!eClass.isAbstract()) {
				return PortDiagramEditorPlugin.getInstance().getItemImageDescriptor(eClass.getEPackage().getEFactoryInstance().create(eClass));
			}
		}
