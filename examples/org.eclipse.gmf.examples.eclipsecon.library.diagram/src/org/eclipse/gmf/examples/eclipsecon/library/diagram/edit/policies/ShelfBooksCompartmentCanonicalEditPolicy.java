 ...
 * @generated
 */
public class ShelfBooksCompartmentCanonicalEditPolicy extends
		CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		EObject nextValue;
		int nodeVID;
		for (Iterator values = ((Shelf) modelObject).getBooks().iterator(); values
				.hasNext();) {
			nextValue = (EObject) values.next();
			nodeVID = Library07VisualIDRegistry.getNodeVisualID(viewObject,
					nextValue);
			if (BookEditPart.VISUAL_ID == nodeVID) {
