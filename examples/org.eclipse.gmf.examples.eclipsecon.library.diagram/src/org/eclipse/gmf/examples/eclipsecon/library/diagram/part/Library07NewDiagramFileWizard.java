 ...
 * @generated
 */
public class Library07NewDiagramFileWizard extends Wizard {
	 ...
	 * @generated
	 */
	public Library07NewDiagramFileWizard(IFile selectedModelFile,
			IWorkbenchPage workbenchPage, IStructuredSelection selection,
			EObject diagramRoot, TransactionalEditingDomain editingDomain) {
		assert selectedModelFile != null : "Null selectedModelFile in Library07NewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert workbenchPage != null : "Null workbenchPage in Library07NewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert selection != null : "Null selection in Library07NewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert diagramRoot != null : "Null diagramRoot in Library07NewDiagramFileWizard constructor"; //$NON-NLS-1$
		assert editingDomain != null : "Null editingDomain in Library07NewDiagramFileWizard constructor"; //$NON-NLS-1$
	...
	public void addPages() {
		myFileCreationPage = new WizardNewFileCreationPage(
			...
			public void createControl(Composite parent) {
				...
				String originalFileName = mySelectedModelFile
						...
						.lastSegment();
				String fileExtension = ".library_diagram"; //$NON-NLS-1$
		...
		myFileCreationPage.setDescription("Create new diagram based on "
				+ LibraryEditPart.MODEL_ID + " model content");
	...
	public boolean performFinish() {
		...
		AbstractTransactionalCommand command = new AbstractTransactionalCommand(
			...
			protected CommandResult doExecuteWithResult(
				...
				int diagramVID = Library07VisualIDRegistry
						.getDiagramVisualID(myDiagramRoot);
				if (diagramVID != LibraryEditPart.VISUAL_ID) {
		...
		try {
			...
			Library07DiagramEditorUtil.openDiagram(diagramResource);
	...
	private class RootElementSelectorPage extends WizardPage implements
		...
		private void createModelBrowser(Composite parent) {
			...
			treeViewer.setContentProvider(new AdapterFactoryContentProvider(
					Library07DiagramEditorPlugin.getInstance()
