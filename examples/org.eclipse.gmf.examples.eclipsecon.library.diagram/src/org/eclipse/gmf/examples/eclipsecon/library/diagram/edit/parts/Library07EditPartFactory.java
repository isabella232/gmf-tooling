 ...
 * @generated
 */
public class Library07EditPartFactory implements EditPartFactory {
	...
	public EditPart createEditPart(EditPart context, Object model) {
		if (model instanceof View) {
			...
			case AuthorEditPart.VISUAL_ID:
				return new AuthorEditPart(view);

			case AuthorNameEditPart.VISUAL_ID:
				return new AuthorNameEditPart(view);

			case ShelfEditPart.VISUAL_ID:
				return new ShelfEditPart(view);

			case ShelfNameEditPart.VISUAL_ID:
				return new ShelfNameEditPart(view);
			...
			case BookEditPart.VISUAL_ID:
				return new BookEditPart(view);

			case ShelfBooksCompartmentEditPart.VISUAL_ID:
				return new ShelfBooksCompartmentEditPart(view);

			case EmployeeShelvesEditPart.VISUAL_ID:
				return new EmployeeShelvesEditPart(view);
			}
		}
