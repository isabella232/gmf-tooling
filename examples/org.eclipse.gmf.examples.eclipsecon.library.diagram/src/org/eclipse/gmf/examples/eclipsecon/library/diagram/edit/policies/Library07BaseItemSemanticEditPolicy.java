...
import org.eclipse.gmf.examples.eclipsecon.library.diagram.edit.helpers.Library07BaseEditHelper;

/**
 * @generated
 */
public class Library07BaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	protected Command getSemanticCommand(IEditCommandRequest request) {
		...
		if (epCommand != null) {
			...
			completedRequest.setParameter(
					Library07BaseEditHelper.EDIT_POLICY_COMMAND, command);
		}
	...
	protected static class LinkConstraints {
		 ...
		 * @generated 
		 */
		public static boolean canCreateEmployeeShelves_3001(Employee source,
				Shelf target) {
			if (source != null) {
				if (source.getShelves().contains(target)) {
					return false;
				}
			}
			return true;
