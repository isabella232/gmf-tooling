 ...
 * @generated
 */
public class Library07NavigatorContentProvider implements
	...
	public Object[] getChildren(Object parentElement) {
		if (parentElement instanceof IFile) {
			...
			result.addAll(createNavigatorItems(selectViewsByType(resource
					.getContents(), LibraryEditPart.MODEL_ID), file, false));
			return result.toArray();
		}

		if (parentElement instanceof Library07NavigatorGroup) {
			Library07NavigatorGroup group = (Library07NavigatorGroup) parentElement;
			return group.getChildren();
		}

		if (parentElement instanceof Library07NavigatorItem) {
			Library07NavigatorItem navigatorItem = (Library07NavigatorItem) parentElement;
	...
	private Collection createNavigatorItems(Collection views, Object parent,
		...
		Collection result = new ArrayList();
		for (Iterator it = views.iterator(); it.hasNext();) {
			result.add(new Library07NavigatorItem((View) it.next(), parent,
					isLeafs));
		}
		return result;
	}
	...
	public Object getParent(Object element) {
		if (element instanceof Library07AbstractNavigatorItem) {
			Library07AbstractNavigatorItem abstractNavigatorItem = (Library07AbstractNavigatorItem) element;
