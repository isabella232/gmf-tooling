 ...
 * @generated
 */
public class Library07LoadResourceAction implements IObjectActionDelegate {

	/**
	 * @generated
	 */
	private LibraryEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof LibraryEditPart) {
				mySelectedElement = (LibraryEditPart) structuredSelection
						.getFirstElement();
			}
		}
