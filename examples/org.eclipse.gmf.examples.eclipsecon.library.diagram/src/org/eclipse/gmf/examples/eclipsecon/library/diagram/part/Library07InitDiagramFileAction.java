 ...
 * @generated
 */
public class Library07InitDiagramFileAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		Wizard wizard = new Library07NewDiagramFileWizard(mySelectedModelFile,
				myPart.getSite().getPage(), mySelection, diagramRoot,
				editingDomain);
		IDialogSettings pluginDialogSettings = Library07DiagramEditorPlugin
		...
		wizard.setWindowTitle("Initialize new " + LibraryEditPart.MODEL_ID
				+ " diagram file");
