 ...
 * @generated
 */
public class Library07MatchingStrategy implements IEditorMatchingStrategy {
	...
	public boolean matches(IEditorReference editorRef, IEditorInput input) {
		...
		if (input instanceof DiagramEditorInput
				&& editor instanceof Library07DiagramEditor) {
			Diagram editorDiagram = ((Library07DiagramEditor) editor)
					.getDiagram();
