...
import org.eclipse.gmf.examples.eclipsecon.library.diagram.edit.policies.EmployeeItemSemanticEditPolicy;
...
public class EmployeeEditPart extends ShapeNodeEditPart {
	...
	protected IFigure createNodeShape() {
		EmployeeFigure figure = new EmployeeFigure();
	...
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof EmployeeNameEditPart) {
			((EmployeeNameEditPart) childEditPart).setLabel(getPrimaryShape()
					.getFigureEmployeeNameFigure());
			return true;
		}
		return false;
	}
	...
	public class EmployeeFigure extends RectangleFigure {
		...
		private void createContents() {
			...
			WrapLabel employeeNameFigure0 = new WrapLabel();
		 ...
		 * @generated
		 */
		private WrapLabel fEmployeeNameFigure;

		/**
		 * @generated
		 */
		public WrapLabel getFigureEmployeeNameFigure() {
		 ...
		 * @generated
		 */
		private void setFigureEmployeeNameFigure(WrapLabel fig) {
