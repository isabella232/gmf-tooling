 ...
 * @generated
 */
public class Library07CreationWizardPage extends WizardNewFileCreationPage {
	 ...
	 * @generated
	 */
	public Library07CreationWizardPage(String pageName,
	...
	private String getUniqueFileName(IPath containerFullPath, String fileName) {
		...
		int i = 1;
		while (Library07DiagramEditorUtil.exists(filePath)) {
			i++;
