 ...
 * @generated
 */
public class BookEditPart extends CompartmentEditPart implements
		ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new BookItemSemanticEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE,
				new Library07TextNonResizableEditPolicy());
	...
	protected Image getLabelIcon() {
		...
		return Library07ElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof Library07TextSelectionEditPolicy) {
			((Library07TextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), Library07EditPartFactory
	...
	protected IFigure createFigurePrim() {
		return new BookTitleFigure();
	}

	/**
	 * @generated
	 */
	public class BookTitleFigure extends WrapLabel {
		/**
		 * @generated
		 */
