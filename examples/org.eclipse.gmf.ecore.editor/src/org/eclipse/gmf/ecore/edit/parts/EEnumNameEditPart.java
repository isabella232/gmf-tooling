...
public class EEnumNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EEnum_2005, getParserElement(), EcoreVisualIDRegistry.getType(org.eclipse.gmf.ecore.edit.parts.EEnumNameEditPart.VISUAL_ID));
		}
		return parser;
	}
