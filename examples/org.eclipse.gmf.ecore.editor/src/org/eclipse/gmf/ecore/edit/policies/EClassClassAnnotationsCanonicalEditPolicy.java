...
public class EClassClassAnnotationsCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		return EcoreDiagramUpdater.getEClassClassAnnotations_7003SemanticChildren(viewObject);
	}
	...
	protected boolean isOrphaned(Collection semanticChildren, final View view) {
		...
		return EcoreDiagramUpdater.isEClassClassAnnotations_7003DomainMetaChild(visualID)
