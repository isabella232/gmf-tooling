...
public class EReferenceNameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(EcoreVisualIDRegistry.getType(org.eclipse.gmf.ecore.edit.parts.EReferenceNameEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EReference_4002, getParserElement(),
					EcoreVisualIDRegistry.getType(org.eclipse.gmf.ecore.edit.parts.EReferenceNameEditPart.VISUAL_ID));
		}
		return parser;
	}
