 ...
 * @generated
 */
public class EReference_nameEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(EcoreVisualIDRegistry.getType(EReference_nameEditPart.VISUAL_ID), new Point(0, 40));
	}
