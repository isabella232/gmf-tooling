...
public class EDataTypeItemSemanticEditPolicy extends EcoreBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = allEdges.iterator(); it.hasNext();) {
			...
			EditCommandRequestWrapper editCommandRequest = new EditCommandRequestWrapper(new DestroyElementRequest(((EDataTypeEditPart) getHost()).getEditingDomain(), req.isConfirmationRequired()),
