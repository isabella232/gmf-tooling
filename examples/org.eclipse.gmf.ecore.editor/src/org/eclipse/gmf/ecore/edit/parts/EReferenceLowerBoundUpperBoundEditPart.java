...
public class EReferenceLowerBoundUpperBoundEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(EcoreVisualIDRegistry.getType(org.eclipse.gmf.ecore.edit.parts.EReferenceLowerBoundUpperBoundEditPart.VISUAL_ID), new Point(0, 60));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EReference_4002, getParserElement(),
					EcoreVisualIDRegistry.getType(org.eclipse.gmf.ecore.edit.parts.EReferenceLowerBoundUpperBoundEditPart.VISUAL_ID));
		}
		return parser;
	}
