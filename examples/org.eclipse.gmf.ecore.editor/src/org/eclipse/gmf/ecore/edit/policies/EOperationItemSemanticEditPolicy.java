...
public class EOperationItemSemanticEditPolicy extends EcoreBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = allEdges.iterator(); it.hasNext();) {
			...
			EditCommandRequestWrapper editCommandRequest = new EditCommandRequestWrapper(new DestroyElementRequest(((EOperationEditPart) getHost()).getEditingDomain(), req.isConfirmationRequired()),
