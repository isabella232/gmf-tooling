...
public class EPackagePackagesCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return EPackage3EditPart.VISUAL_ID == EcoreVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<EcoreNodeDescriptor> childDescriptors = EcoreDiagramUpdater.getEPackagePackages_7005SemanticChildren((View) getHost().getModel());
