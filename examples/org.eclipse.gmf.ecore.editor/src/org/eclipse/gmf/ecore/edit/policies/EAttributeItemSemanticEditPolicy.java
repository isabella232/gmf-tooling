...
public class EAttributeItemSemanticEditPolicy extends EcoreBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = allEdges.iterator(); it.hasNext();) {
			...
			EditCommandRequestWrapper editCommandRequest = new EditCommandRequestWrapper(new DestroyElementRequest(((EAttributeEditPart) getHost()).getEditingDomain(), req.isConfirmationRequired()),
