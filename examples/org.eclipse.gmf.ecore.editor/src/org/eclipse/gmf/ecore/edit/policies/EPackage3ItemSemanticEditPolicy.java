...
public class EPackage3ItemSemanticEditPolicy extends EcoreBaseItemSemanticEditPolicy {
	...
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator it = allEdges.iterator(); it.hasNext();) {
			...
			EditCommandRequestWrapper editCommandRequest = new EditCommandRequestWrapper(new DestroyElementRequest(((EPackage3EditPart) getHost()).getEditingDomain(), req.isConfirmationRequired()),
