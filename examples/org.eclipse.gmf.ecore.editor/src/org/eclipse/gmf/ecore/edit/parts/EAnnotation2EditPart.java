...
public class EAnnotation2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EAnnotation_3003, getParserElement(),
					EcoreVisualIDRegistry.getType(org.eclipse.gmf.ecore.edit.parts.EAnnotation2EditPart.VISUAL_ID));
		}
		return parser;
	}
