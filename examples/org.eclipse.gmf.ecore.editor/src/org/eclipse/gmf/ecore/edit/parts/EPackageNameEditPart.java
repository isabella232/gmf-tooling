...
public class EPackageNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EPackage_2002, getParserElement(), EcoreVisualIDRegistry.getType(org.eclipse.gmf.ecore.edit.parts.EPackageNameEditPart.VISUAL_ID));
		}
		return parser;
	}
