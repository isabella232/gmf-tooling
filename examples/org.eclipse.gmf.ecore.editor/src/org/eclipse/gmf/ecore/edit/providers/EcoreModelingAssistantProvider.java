...
public class EcoreModelingAssistantProvider extends ModelingAssistantProvider {
	...
	public List getTypesForPopupBar(IAdaptable host) {
		...
		if (editPart instanceof EPackageEditPart) {
			...
			return children;
		} else if (editPart instanceof EClass_attributesEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EAttribute_2001);
			return children;
		} else if (editPart instanceof EClass_operationsEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EOperation_2002);
			return children;
		} else if (editPart instanceof EClass_classannotationsEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EAnnotation_2003);
			return children;
		} else if (editPart instanceof EPackage_classesEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EClass_2004);
			return children;
		} else if (editPart instanceof EPackage_packagesEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EPackage_2005);
			return children;
		} else if (editPart instanceof EPackage_datatypesEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EDataType_2006);
			return children;
		} else if (editPart instanceof EPackage_enumsEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EEnum_2007);
			return children;
		} else if (editPart instanceof EPackage_packageannotationsEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EAnnotation_2008);
			return children;
		} else if (editPart instanceof EAnnotation_detailsEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EStringToStringMapEntry_2009);
			return children;
		} else if (editPart instanceof EDataType_datatypeannotationsEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EAnnotation_2010);
			return children;
		} else if (editPart instanceof EEnum_literalsEditPart) {
			List children = new ArrayList();
			children.add(EcoreElementTypes.EEnumLiteral_2011);
			return children;
		} else if (editPart instanceof EEnum_enumannotationsEditPart) {
			List children = new ArrayList();
