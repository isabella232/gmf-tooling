 ...
 * @generated
 */
public class EReferenceLowerBoundUpperBound2EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 * @generated
	 */
	public EReferenceLowerBoundUpperBound2EditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new EPackageEditPart.LinkLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = EcoreParserProvider.getParser(EcoreElementTypes.EReference_4003, getParserElement(),
					EcoreVisualIDRegistry.getType(org.eclipse.gmf.ecore.edit.parts.EReferenceLowerBoundUpperBound2EditPart.VISUAL_ID));
		}
		return parser;
	}
