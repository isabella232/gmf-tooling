...
public class EClassAttributesCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	protected List getSemanticChildrenList() {
		...
		return EcoreDiagramUpdater.getEClassAttributes_7001SemanticChildren(viewObject);
	}
	...
	protected boolean isOrphaned(Collection semanticChildren, final View view) {
		...
		return EcoreDiagramUpdater.isEClassAttributes_7001DomainMetaChild(visualID)
