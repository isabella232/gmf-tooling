...
import org.eclipse.gmf.examples.eclipsecon.diagram.edit.commands.EclipseconReorientConnectionViewCommand;

/**
 * @generated
 */
public class EclipseconGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
	...
	protected Command getConnectionWithReorientedViewCompleteCommand(
		...
		TransactionalEditingDomain editingDomain = ((IGraphicalEditPart) getHost())
				.getEditingDomain();
		EclipseconReorientConnectionViewCommand rcvCommand = new EclipseconReorientConnectionViewCommand(
				editingDomain, null);
