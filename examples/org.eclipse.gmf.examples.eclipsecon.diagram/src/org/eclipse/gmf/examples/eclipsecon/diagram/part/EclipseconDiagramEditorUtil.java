...
public class EclipseconDiagramEditorUtil extends IDEEditorUtil {
	...
	public static final IFile createNewDiagramFile(
		...
		final Resource diagramResource = editingDomain
				.createResource(diagramFilePath.toOSString());
		IPath modelFilePath = diagramFilePath.removeFileExtension()
				.addFileExtension("eclipsecon"); //$NON-NLS-1$
		final Resource modelResource = editingDomain
				.createResource(modelFilePath.toOSString());
