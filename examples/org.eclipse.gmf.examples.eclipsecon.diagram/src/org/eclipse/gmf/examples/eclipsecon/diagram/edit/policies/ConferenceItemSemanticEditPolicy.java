...
public class ConferenceItemSemanticEditPolicy extends
	...
	protected Command getCreateCommand(CreateElementRequest req) {
		...
		if (EclipseconElementTypes.Schedule_1002 == req.getElementType()) {
			...
			return getMSLWrapper(new CreateSchedule_1002Command(req));
		}
		if (EclipseconElementTypes.Tutorial_1003 == req.getElementType()) {
			Conference container = (Conference) (req.getContainer() instanceof View ? ((View) req
					.getContainer()).getElement()
					: req.getContainer());
			...
			return getMSLWrapper(new CreateTutorial_1003Command(req));
		}
	 ...
	 * @generated
	 */
	private static class CreateSchedule_1002Command extends
			CreateElementCommand {

		/**
		 * @generated
		 */
		public CreateSchedule_1002Command(CreateElementRequest req) {
			super(req);
		}
	 ...
	 * @generated
	 */
	private static class CreateTutorial_1003Command extends
			CreateElementCommand {

		/**
		 * @generated
		 */
		public CreateTutorial_1003Command(CreateElementRequest req) {
			super(req);
		}
