 ...
 * @generated
 */
public class EclipseconStructuralFeaturesParser extends
		EclipseconAbstractParser {
	 ...
	 * @generated
	 */
	public EclipseconStructuralFeaturesParser(List features) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		for (int i = 0; i < values.length; i++) {
			...
			if (value instanceof InvalidValue) {
				return new ParserEditStatus(EclipseconDiagramEditorPlugin.ID,
