...
import org.eclipse.gmf.examples.eclipsecon.diagram.part.EclipseconPaletteFactory;

/**
 * @generated
 */
public class EclipseconPaletteProvider extends AbstractProvider implements
		IPaletteProvider {
	...
	public void contributeToPalette(IEditorPart editor, Object content,
			PaletteRoot root) {
		EclipseconPaletteFactory factory = new EclipseconPaletteFactory();
