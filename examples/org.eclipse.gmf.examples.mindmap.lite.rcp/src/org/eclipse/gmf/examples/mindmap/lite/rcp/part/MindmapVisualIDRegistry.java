...
import org.eclipse.gmf.examples.mindmap.lite.rcp.expressions.MindmapAbstractExpression;
import org.eclipse.gmf.examples.mindmap.lite.rcp.expressions.MindmapOCLFactory;
...
public class MindmapVisualIDRegistry {
	...
	public static int getVisualID(View view) {
		...
		return org.eclipse.gmf.examples.mindmap.lite.rcp.part.MindmapVisualIDRegistry
	...
	public static int getNodeVisualID(View containerView, EObject domainElement) {
		if (domainElement == null
				|| !MapEditPart.MODEL_ID
						.equals(org.eclipse.gmf.examples.mindmap.lite.rcp.part.MindmapVisualIDRegistry
								.getModelID(containerView))) {
			return -1;
		}
		switch (org.eclipse.gmf.examples.mindmap.lite.rcp.part.MindmapVisualIDRegistry
