...
import org.eclipse.gmf.examples.mindmap.lite.rcp.edit.policies.RelationshipComponentEditPolicy;
import org.eclipse.gmf.examples.mindmap.lite.rcp.edit.policies.RelationshipGraphicalNodeEditPolicy;
...
public class RelationshipEditPart extends AbstractConnectionEditPart implements
	 ...
	 * @generated
	 */
	public RelationshipEditPart(View model) {
	...
	protected void createEditPolicies() {
		installEditPolicy(EditPolicy.COMPONENT_ROLE,
				new RelationshipComponentEditPolicy());
		...
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new RelationshipGraphicalNodeEditPolicy());
	}
