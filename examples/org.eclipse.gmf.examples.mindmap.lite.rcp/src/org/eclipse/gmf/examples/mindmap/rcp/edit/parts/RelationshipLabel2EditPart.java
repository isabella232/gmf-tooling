 ...
 * @generated
 */
public class RelationshipLabel2EditPart extends AbstractGraphicalEditPart
	 ...
	 * @generated
	 */
	public RelationshipLabel2EditPart(View model) {
	...
	protected void refreshLocation() {
		...
		Relationship2EditPart parent = getUpdatableParent();
	 ...
	 * @generated
	 */
	private Relationship2EditPart getUpdatableParent() {
		assert getParent() instanceof Relationship2EditPart;
		return (Relationship2EditPart) getParent();
	}
	...
	public void activate() {
		super.activate();
		Relationship2EditPart updatableParent = getUpdatableParent();
