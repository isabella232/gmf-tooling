 ...
 * @generated
 */
public class ThreadSubjectEditPart extends AbstractGraphicalEditPart implements
		ILabelController {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public ThreadSubjectEditPart(View model) {
	...
	private static ILabelTextDisplayer createLabelTextDisplayer() {
		return new MessageFormatLabelTextDisplayer(
				...
				null,
				null,
				new EAttribute[] { MindmapPackage.eINSTANCE.getThread_Subject() });
	}
	...
	private ThreadEditPart getUpdatableParent() {
		assert getParent() instanceof ThreadEditPart;
		return (ThreadEditPart) getParent();
	}
