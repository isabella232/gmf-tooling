...
import org.eclipse.gmf.examples.mindmap.lite.rcp.diagram.edit.commands.CreateThreadItem3002Command;
 ...
 * @generated
 */
public class ThreadThreadItemCompartmentEditPart extends
		AbstractGraphicalEditPart implements IUpdatableEditPart {
	 ...
	 * @generated
	 */
	public ThreadThreadItemCompartmentEditPart(View view) {
		setModel(view);
	}
		...
		installEditPolicy(EditPolicy.LAYOUT_ROLE,
				new ConstrainedLayoutEditPolicy() {
						...
						if (child.getModel() instanceof Node) {
							...
							if (MapEditPart.MODEL_ID.equals(modelID)) {
								...
								final int newVisualID = MindmapVisualIDRegistry.INSTANCE
										.getNodeVisualID(getDiagramNode(),
												childNode.getElement());
									...
									result.append(AddCommand
											.create(editingDomain,
													...
													MindmapPackage.eINSTANCE
															.getThread_Items(),
													element));
									result.append(RemoveCommand.create(
											editingDomain, childNode
													.eContainer(), childNode
													.eContainmentFeature(),
											childNode));
										...
										result
												.append(AddCommand
														.create(
																...
																childNode));
										result.append(new SetBoundsCommand(
												childNode, null));
									} else {
										result
					...
					protected Command getCloneCommand(
						...
						command
								.setDebugLabel("Clone in ConstrainedLayoutEditPolicy");//$NON-NLS-1$
								...
								case ThreadItemEditPart.VISUAL_ID:
									command = new CommandWrapper() {
										...
										protected org.eclipse.emf.common.command.Command createCommand() {
											...
											return CopyCommand.create(
													editingDomain, element);
										}
					...
					protected Command getCreateCommand(CreateRequest request) {
						if (request instanceof CreateRequestEx) {
							...
							for (int i = 0; i < visualIds.length; i++) {
								...
								case ThreadItemEditPart.VISUAL_ID:
									result
											.append(new CreateThreadItem3002Command(
													(View) getModel(),
													requestEx));
									break;
								}
							...
							return new WrappingCommand(TransactionUtil
									.getEditingDomain(((View) getModel())
	...
	public List createSelectionHandles() {
		return Collections.singletonList(new CompartmentNameHandle(this,
				getTitleName()));
	}
