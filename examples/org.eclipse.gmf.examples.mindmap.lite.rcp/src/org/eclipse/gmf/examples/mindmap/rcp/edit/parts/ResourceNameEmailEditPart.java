...
import org.eclipse.gmf.runtime.lite.edit.parts.labels.BaseExternalNodeLabelEditPart;
 ...
 * @generated
 */
public class ResourceNameEmailEditPart extends BaseExternalNodeLabelEditPart
	 ...
	 * @generated
	 */
	public ResourceNameEmailEditPart(View model) {
		super(model);
	}
	...
	private static ILabelTextDisplayer createLabelTextDisplayer() {
		return new MessageFormatLabelTextDisplayer(
				"{0} [{1}]", "{0} : {1}", "{0} : {1}", new EAttribute[] { MindmapPackage.eINSTANCE.getResource_Name(), MindmapPackage.eINSTANCE.getResource_Email() }); //$NON-NLS-1$//$NON-NLS-2$//$NON-NLS-3$
	}
	...
	private ResourceEditPart getUpdatableParent() {
		assert getParent() instanceof ResourceEditPart;
		return (ResourceEditPart) getParent();
	}
