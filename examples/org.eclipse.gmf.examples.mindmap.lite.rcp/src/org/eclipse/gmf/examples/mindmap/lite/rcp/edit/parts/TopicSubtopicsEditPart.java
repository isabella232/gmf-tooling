...
import org.eclipse.gmf.examples.mindmap.lite.rcp.edit.policies.TopicSubtopicsComponentEditPolicy;
import org.eclipse.gmf.examples.mindmap.lite.rcp.edit.policies.TopicSubtopicsGraphicalNodeEditPolicy;
...
public class TopicSubtopicsEditPart extends AbstractConnectionEditPart
		implements IUpdatableEditPart, IExternallyUpdatableEditPart,
		IDecoratableEditPart, NodeEditPart {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public TopicSubtopicsEditPart(View model) {
	...
	protected void createEditPolicies() {
		installEditPolicy(EditPolicy.COMPONENT_ROLE,
				new TopicSubtopicsComponentEditPolicy());
		installEditPolicy(EditPolicy.CONNECTION_ENDPOINTS_ROLE,
				new ConnectionEndpointEditPolicy());
		installEditPolicy(EditPolicy.CONNECTION_BENDPOINTS_ROLE,
				new BendpointEditPolicy());
		installEditPolicy(EditPolicy.GRAPHICAL_NODE_ROLE,
				new TopicSubtopicsGraphicalNodeEditPolicy());
	}
