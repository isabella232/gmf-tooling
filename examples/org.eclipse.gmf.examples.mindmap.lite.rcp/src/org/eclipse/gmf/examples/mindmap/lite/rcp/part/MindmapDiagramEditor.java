...
import org.eclipse.gmf.examples.mindmap.lite.rcp.edit.parts.MindmapEditPartFactory;
import org.eclipse.gmf.examples.mindmap.lite.rcp.providers.MindmapValidationProvider;
...
public class MindmapDiagramEditor extends DiagramEditor {
	 ...
	 * @generated
	 */
	public static final String ID = "org.eclipse.gmf.examples.mindmap.lite.rcp.part.MindmapDiagramEditorID"; //$NON-NLS-1$
	...
	protected void createActions() {
		...
		addAction(new MindmapValidationProvider.ValidateAction(this));
	...
	private class MindmapDiagramEditorContextMenuProvider extends
		...
		public void buildContextMenu(IMenuManager menuManager) {
			...
			appendActionToMenu(
					menuManager,
					MindmapValidationProvider.ValidateAction.VALIDATE_ACTION_KEY,
					GEFActionConstants.GROUP_REST);
