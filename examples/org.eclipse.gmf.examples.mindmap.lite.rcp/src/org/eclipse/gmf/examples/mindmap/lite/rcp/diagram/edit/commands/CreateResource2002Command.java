 ...
 * @generated
 */
public class CreateResource2002Command extends AbstractCommand {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public CreateResource2002Command(View parent, CreateRequestEx request) {
	...
	public CreateResource2002Command(View parent, CreateRequestEx request,
		...
		Resource createdDomainElement = MindmapFactory.eINSTANCE
				.createResource();

		DomainElementInitializer.Resource_2002
		...
		this.domainModelAddCommand = AddCommand.create(domainModelEditDomain,
				parent.getElement(), MindmapPackage.eINSTANCE
						.getMap_Resources(), createdDomainElement);
		if (constraint != null) {
			constraint = constraint.union(new Dimension(40, 60));
		}
		this.notationAddCommand = new CreateNotationalNodeCommand(parent,
				createdDomainElement, constraint, ResourceViewFactory.INSTANCE);
