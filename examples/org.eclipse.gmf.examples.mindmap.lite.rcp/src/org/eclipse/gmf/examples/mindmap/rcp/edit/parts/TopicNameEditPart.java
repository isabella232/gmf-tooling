 ...
 * @generated
 */
public class TopicNameEditPart extends AbstractGraphicalEditPart implements
		ILabelController {
	/**
	 * @generated
	 */
	 ...
	 * @generated
	 */
	public TopicNameEditPart(View model) {
	...
	private static ILabelTextDisplayer createLabelTextDisplayer() {
		return new MessageFormatLabelTextDisplayer(null, null, null,
				new EAttribute[] { MindmapPackage.eINSTANCE.getTopic_Name() });
	}
	...
	private TopicEditPart getUpdatableParent() {
		assert getParent() instanceof TopicEditPart;
		return (TopicEditPart) getParent();
	}
