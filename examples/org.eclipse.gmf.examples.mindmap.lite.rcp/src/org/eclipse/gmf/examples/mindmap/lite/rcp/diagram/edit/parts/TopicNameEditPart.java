 ...
 * @generated
 */
public class TopicNameEditPart extends AbstractGraphicalEditPart {
	...
	protected void createEditPolicies() {
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new DirectEditPolicy() {
			...
			org.eclipse.emf.common.command.Command createDomainModelCommand(
				...
				Topic element = resolveSemanticElement();
	 ...
	 * @generated
	 */
	public static String buildTextByPattern(Topic element, String pattern) {
		return MessageFormat
				.format(pattern, new Object[] { element.getName() });
	}
	 ...
	 * @generated
	 */
	private Topic resolveSemanticElement() {
		View view = (View) getModel();
		return (view.getElement() instanceof Topic) ? (Topic) view.getElement()
				: null;
	}
	...
	public void activate() {
		super.activate();
		TopicEditPart updatableParent = getUpdatableParent();
