 ...
 * @generated
 */
public class ThreadSubjectEditPart extends AbstractGraphicalEditPart {
	 ...
	 * @generated
	 */
	public ThreadSubjectEditPart(View view) {
		setModel(view);
	}
	...
	protected void createEditPolicies() {
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new DirectEditPolicy() {
			...
			org.eclipse.emf.common.command.Command createDomainModelCommand(
				...
				Thread element = resolveSemanticElement();
	 ...
	 * @generated
	 */
	public static String buildTextByPattern(Thread element, String pattern) {
		return MessageFormat.format(pattern, new Object[] { element
				.getSubject() });
	}
	 ...
	 * @generated
	 */
	private Thread resolveSemanticElement() {
		View view = (View) getModel();
		return (view.getElement() instanceof Thread) ? (Thread) view
				.getElement() : null;
	}
	...
	public void activate() {
		super.activate();
		ThreadEditPart updatableParent = getUpdatableParent();
		if (updatableParent != null) {
			...
			updatableParent.addRefresher(MindmapPackage.eINSTANCE
					.getThread_Subject(), labelRefresher);
		}
	}
