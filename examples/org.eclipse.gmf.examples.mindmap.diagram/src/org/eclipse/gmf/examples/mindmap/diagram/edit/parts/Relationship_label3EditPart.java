 ...
 * @generated
 */
public class Relationship_label3EditPart extends LabelEditPart implements
		ITextAwareEditPart {
	...
	static {
		registerSnapBackPosition(MindmapVisualIDRegistry
				.getType(Relationship_label3EditPart.VISUAL_ID), new Point(0,
				40));
	}
	 ...
	 * @generated
	 */
	public Relationship_label3EditPart(View view) {
		super(view);
	}
