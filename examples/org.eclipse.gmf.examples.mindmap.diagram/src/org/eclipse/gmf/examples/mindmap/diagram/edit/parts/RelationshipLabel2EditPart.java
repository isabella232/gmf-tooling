 ...
 * @generated
 */
public class RelationshipLabel2EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MindmapVisualIDRegistry.getType(RelationshipLabel2EditPart.VISUAL_ID), new Point(0, 40));
	}
