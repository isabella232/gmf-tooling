 ...
 * @generated
 */
public class RelationshipLabelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MindmapVisualIDRegistry.getType(RelationshipLabelEditPart.VISUAL_ID), new Point(0, 40));
	}
