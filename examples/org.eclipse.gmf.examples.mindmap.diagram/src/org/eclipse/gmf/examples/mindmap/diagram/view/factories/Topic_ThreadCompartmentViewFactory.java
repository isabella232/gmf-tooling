 ...
 * @generated
 */
public class Topic_ThreadCompartmentViewFactory extends
	...
	protected void decorateView(View containerView, View view,
		...
		if (semanticHint == null) {
			semanticHint = MindmapVisualIDRegistry
					.getType(org.eclipse.gmf.examples.mindmap.diagram.edit.parts.Topic_ThreadCompartmentEditPart.VISUAL_ID);
