...
public class ResourceViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = MindmapVisualIDRegistry.getType(ResourceEditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view, MindmapVisualIDRegistry.getType(ResourceNameEmailEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
