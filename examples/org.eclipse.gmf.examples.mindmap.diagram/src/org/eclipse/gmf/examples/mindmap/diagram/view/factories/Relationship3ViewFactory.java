...
public class Relationship3ViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = MindmapVisualIDRegistry.getType(Relationship3EditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view, MindmapVisualIDRegistry.getType(RelationshipLabel3EditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
