 ...
 * @generated
 */
public class RelationshipLabel3EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MindmapVisualIDRegistry.getType(RelationshipLabel3EditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public RelationshipLabel3EditPart(View view) {
		super(view);
	}
