 ...
 * @generated
 */
public class Relationship_labelEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MindmapVisualIDRegistry.getType(Relationship_labelEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public Relationship_labelEditPart(View view) {
		super(view);
	}
