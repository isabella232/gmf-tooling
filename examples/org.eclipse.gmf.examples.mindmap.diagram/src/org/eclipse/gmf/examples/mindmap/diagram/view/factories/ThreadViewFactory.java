...
public class ThreadViewFactory extends AbstractShapeViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = MindmapVisualIDRegistry.getType(org.eclipse.gmf.examples.mindmap.diagram.edit.parts.ThreadEditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view, MindmapVisualIDRegistry.getType(Thread_subjectEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
		getViewService().createNode(semanticAdapter, view, MindmapVisualIDRegistry.getType(Thread_ThreadItemCompartmentEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
}
