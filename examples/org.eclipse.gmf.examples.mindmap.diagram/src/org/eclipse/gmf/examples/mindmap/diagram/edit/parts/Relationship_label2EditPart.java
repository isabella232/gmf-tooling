 ...
 * @generated
 */
public class Relationship_label2EditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(MindmapVisualIDRegistry.getType(Relationship_label2EditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public Relationship_label2EditPart(View view) {
		super(view);
	}
