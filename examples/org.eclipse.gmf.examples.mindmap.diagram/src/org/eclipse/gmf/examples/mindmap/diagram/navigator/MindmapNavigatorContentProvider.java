	...
	private Object[] getViewChildren(View view, Object parentElement) {
		...
		case MapEditPart.VISUAL_ID: {
			...
			MindmapNavigatorGroup links = new MindmapNavigatorGroup(
					Messages.NavigatorGroupName_Map_1000_links,
		...
		case TopicEditPart.VISUAL_ID: {
			...
			MindmapNavigatorGroup incominglinks = new MindmapNavigatorGroup(
					Messages.NavigatorGroupName_Topic_2001_incominglinks,
					"icons/incomingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			MindmapNavigatorGroup outgoinglinks = new MindmapNavigatorGroup(
					Messages.NavigatorGroupName_Topic_2001_outgoinglinks,
					"icons/outgoingLinksNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view), TopicThreadCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					ThreadEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			...
			outgoinglinks.addChildren(createNavigatorItems(connectedViews,
					outgoinglinks, true));
			connectedViews = getIncomingLinksByType(
					Collections.singleton(view), RelationshipEditPart.VISUAL_ID);
			incominglinks.addChildren(createNavigatorItems(connectedViews,
					incominglinks, true));
			connectedViews = getOutgoingLinksByType(
					Collections.singleton(view), RelationshipEditPart.VISUAL_ID);
		...
		case ThreadEditPart.VISUAL_ID: {
			...
			Collection connectedViews = getChildrenByType(Collections
					.singleton(view),
					ThreadThreadItemCompartmentEditPart.VISUAL_ID);
			connectedViews = getChildrenByType(connectedViews,
					ThreadItemEditPart.VISUAL_ID);
			result.addAll(createNavigatorItems(connectedViews, parentElement,
					false));
			return result.toArray();
		}
		...
		case TopicSubtopicsEditPart.VISUAL_ID: {
			...
			MindmapNavigatorGroup target = new MindmapNavigatorGroup(
					Messages.NavigatorGroupName_TopicSubtopics_4001_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			MindmapNavigatorGroup source = new MindmapNavigatorGroup(
					Messages.NavigatorGroupName_TopicSubtopics_4001_source,
		...
		case RelationshipEditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			MindmapNavigatorGroup target = new MindmapNavigatorGroup(
					Messages.NavigatorGroupName_Relationship_4002_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			MindmapNavigatorGroup source = new MindmapNavigatorGroup(
		...
		case Relationship3EditPart.VISUAL_ID: {
			Collection result = new ArrayList();
			MindmapNavigatorGroup target = new MindmapNavigatorGroup(
					Messages.NavigatorGroupName_Relationship_4004_target,
					"icons/linkTargetNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			MindmapNavigatorGroup source = new MindmapNavigatorGroup(
					Messages.NavigatorGroupName_Relationship_4004_source,
					"icons/linkSourceNavigatorGroup.gif", parentElement); //$NON-NLS-1$
			Collection connectedViews = getLinksTargetByType(Collections
					.singleton(view), TopicEditPart.VISUAL_ID);
			target.addChildren(createNavigatorItems(connectedViews, target,
