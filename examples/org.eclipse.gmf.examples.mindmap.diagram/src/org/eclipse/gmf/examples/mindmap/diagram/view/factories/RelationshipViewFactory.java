...
public class RelationshipViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = MindmapVisualIDRegistry.getType(RelationshipEditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view, MindmapVisualIDRegistry.getType(RelationshipLabelEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
