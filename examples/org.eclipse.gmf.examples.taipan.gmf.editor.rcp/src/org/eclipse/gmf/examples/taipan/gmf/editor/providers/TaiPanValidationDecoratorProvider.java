...
import org.eclipse.gmf.examples.taipan.gmf.editor.part.ValidationMarker;
	...
	public static class StatusDecorator extends AbstractDecorator {
		...
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				TaiPanDiagramEditorPlugin.getInstance().logError("ViewID access failure", e); //$NON-NLS-1$			
			}
		}
		...
		public void refresh() {
			...
			ValidationMarker[] markers = ValidationMarker.getMarkers(editPart.getViewer(), viewId);
