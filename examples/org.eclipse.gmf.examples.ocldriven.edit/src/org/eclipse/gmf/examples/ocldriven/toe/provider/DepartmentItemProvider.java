...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmf.examples.ocldriven.toe.Department} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DepartmentItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 TOEPackage.Literals.DEPARTMENT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addManagerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Department_manager_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Department_manager_feature", "_UI_Department_type"),
				 TOEPackage.Literals.DEPARTMENT__MANAGER,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(TOEPackage.Literals.DEPARTMENT__SUB_DEPARTMENTS);
			childrenFeatures.add(TOEPackage.Literals.DEPARTMENT__EMPLOYEES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(TOEPackage.Literals.DEPARTMENT__SUB_DEPARTMENTS,
				 TOEFactory.eINSTANCE.createDepartment()));

		newChildDescriptors.add
			(createChildParameter
				(TOEPackage.Literals.DEPARTMENT__EMPLOYEES,
