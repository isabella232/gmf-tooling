...
public class TaiPanViewProvider extends AbstractProvider implements IViewProvider {
	...
	protected boolean provides(CreateDiagramViewOperation op) {
		return PortEditPart.MODEL_ID.equals(op.getSemanticHint()) && TaiPanVisualIDRegistry.getDiagramVisualID(getSemanticElement(op.getSemanticAdapter())) != -1;
	}
	...
	protected boolean provides(CreateNodeViewOperation op) {
		...
		if (op.getSemanticHint() == null) {
			...
			if (elementType != null) {
				...
				if (!PortEditPart.MODEL_ID.equals(TaiPanVisualIDRegistry.getModelID(op.getContainerView()))) {
		...
		return BuildingEditPart.VISUAL_ID == visualID;
	}
	...
	public Diagram createDiagram(IAdaptable semanticAdapter, String diagramKind, PreferencesHint preferencesHint) {
		...
		diagram.setType(PortEditPart.MODEL_ID);
	...
	public Node createNode(IAdaptable semanticAdapter, View containerView, String semanticHint, int index, boolean persisted, PreferencesHint preferencesHint) {
		...
		switch (visualID) {
		case BuildingEditPart.VISUAL_ID:
			return createBuilding_2001(domainElement, containerView, index, persisted, preferencesHint);
		}
	 ...
	 * @generated
	 */
	public Node createBuilding_2001(EObject domainElement, View containerView, int index, boolean persisted, PreferencesHint preferencesHint) {
		Shape node = NotationFactory.eINSTANCE.createShape();
		node.setLayoutConstraint(NotationFactory.eINSTANCE.createBounds());
		node.setType(TaiPanVisualIDRegistry.getType(BuildingEditPart.VISUAL_ID));
		...
		Node label3001 = createLabel(node, TaiPanVisualIDRegistry.getType(BuildingInfoEditPart.VISUAL_ID));
		return node;
	}
