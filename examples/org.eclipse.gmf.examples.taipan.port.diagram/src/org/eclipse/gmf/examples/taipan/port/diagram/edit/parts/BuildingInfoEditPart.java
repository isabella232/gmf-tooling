 ...
 * @generated
 */
public class BuildingInfoEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	 ...
	 * @generated
	 */
	public BuildingInfoEditPart(View view) {
		super(view);
	}
	...
	protected void createDefaultEditPoliciesGen() {
		...
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new PortEditPart.NodeLabelDragPolicy());
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TaiPanParserProvider.getParser(TaiPanElementTypes.Building_2001, getParserElement(),
					TaiPanVisualIDRegistry.getType(org.eclipse.gmf.examples.taipan.port.diagram.edit.parts.BuildingInfoEditPart.VISUAL_ID));
		}
		return parser;
	}
