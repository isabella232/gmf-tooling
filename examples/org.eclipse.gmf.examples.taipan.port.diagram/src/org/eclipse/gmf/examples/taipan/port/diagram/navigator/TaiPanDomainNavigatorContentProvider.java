 ...
 * @generated
 */
public class TaiPanDomainNavigatorContentProvider implements ICommonContentProvider {

	/**
	 * @generated
	 */
	private AdapterFactoryContentProvider myAdapterFctoryContentProvier = new AdapterFactoryContentProvider(PortDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
