...
public class TaiPanNewDiagramFileWizard extends Wizard {
	...
	public boolean performFinish() {
		...
		try {
			...
			PortDiagramEditorPlugin.getInstance().logError("Save operation failed for: " + diagramModelURI, ex); //$NON-NLS-1$
	...
	private static class DiagramRootElementSelectionPage extends ModelElementSelectionPage {
		...
		protected boolean validatePage() {
			...
			boolean result = ViewService.getInstance().provides(
					new CreateDiagramViewOperation(new EObjectAdapter(getModelElement()), PortEditPart.MODEL_ID, PortDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT));
