 ...
 * @generated
 */
public class BuildingAddressEditPart extends LabelEditPart implements ITextAwareEditPart, IBorderItemEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(TaiPanVisualIDRegistry.getType(BuildingAddressEditPart.VISUAL_ID), new Point(0, 0));
	}

	/**
	 * @generated
	 */
	public BuildingAddressEditPart(View view) {
		super(view);
	}
