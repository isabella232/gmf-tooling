		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Presenter_bio_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Presenter_bio_feature", "_UI_Presenter_type"),
				 EclipseconPackage.Literals.PRESENTER__BIO,
				 true,
