...
/**
 * This is the item provider adapter for a {@link org.eclipse.gmf.examples.eclipsecon.Resource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResourceItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 EclipseconPackage.Literals.RESOURCE__NAME,
				 true,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_Resource_location_feature", "_UI_Resource_type"),
				 EclipseconPackage.Literals.RESOURCE__LOCATION,
				 true,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				 null,
				 null));
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Resource.class)) {
			case EclipseconPackage.RESOURCE__NAME:
			case EclipseconPackage.RESOURCE__LOCATION:
