 ...
 * @generated
 */
public class CustomNodeViewFactory extends AbstractShapeViewFactory {
	...
	protected List createStyles(View view) {
		...
		styles.add(Design2DFactory.eINSTANCE.createClassDesignStyle());
		return styles;
	}
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = DesignVisualIDRegistry.getType(CustomNodeEditPart.VISUAL_ID);
