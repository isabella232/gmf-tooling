...
import org.eclipse.gmf.examples.design2d.edit.commands.DesignReorientConnectionViewCommand;

/**
 * @generated
 */
public class DesignGraphicalNodeEditPolicy extends GraphicalNodeEditPolicy {
	...
	protected Command getConnectionWithReorientedViewCompleteCommand(CreateConnectionRequest request) {
		...
		DesignReorientConnectionViewCommand rcvCommand = new DesignReorientConnectionViewCommand(editingDomain, null);
