 ...
 * @generated
 */
public class DesignSheetLabelProvider extends DecoratingLabelProvider {

	/**
	 * @generated
	 */
	public DesignSheetLabelProvider() {
		super(new AdapterFactoryLabelProvider(DesignDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory()), null);
	}
