 ...
 * @generated
 */
public class DesignEditPartProvider extends AbstractEditPartProvider {
	 ...
	 * @generated
	 */
	public DesignEditPartProvider() {
		setFactory(new DesignEditPartFactory());
	...
	public synchronized boolean provides(IOperation operation) {
		if (operation instanceof CreateGraphicEditPartOperation) {
			...
			if (!Design2DEditPart.MODEL_ID.equals(DesignVisualIDRegistry.getModelID(view))) {
				return false;
			}
