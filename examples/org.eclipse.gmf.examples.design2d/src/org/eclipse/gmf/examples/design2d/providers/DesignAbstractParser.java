 ...
 * @generated
 */
public abstract class DesignAbstractParser implements IParser {
	...
	public IParserEditStatus isValidEditString(IAdaptable element, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(DesignDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE, "Invalid input at " + pos.getErrorIndex());
		}
