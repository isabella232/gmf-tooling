...
public class DesignElementTypes {
	...
	private static ImageDescriptor getProvidedImageDescriptor(ENamedElement element) {
		...
		if (element instanceof EClass) {
			...
			if (!eClass.isAbstract()) {
				return DesignDiagramEditorPlugin.getInstance().getItemImageDescriptor(eClass.getEPackage().getEFactoryInstance().create(eClass));
			}
		}
	...
	public static boolean isKnownElementType(IElementType elementType) {
		if (KNOWN_ELEMENT_TYPES == null) {
			...
			KNOWN_ELEMENT_TYPES.add(Unknown_2001);
			KNOWN_ELEMENT_TYPES.add(Unknown_4001);
		}
