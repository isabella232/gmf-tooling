 ...
 * @generated
 */
public class DesignStructuralFeatureParser extends DesignAbstractParser {
	 ...
	 * @generated
	 */
	public DesignStructuralFeatureParser(EStructuralFeature feature) {
	...
	protected IParserEditStatus validateValues(Object[] values) {
		...
		if (value instanceof InvalidValue) {
			return new ParserEditStatus(DesignDiagramEditorPlugin.ID, IParserEditStatus.UNEDITABLE, value.toString());
		}
