...
import org.eclipse.gmf.examples.design2d.edit.policies.DesignTextSelectionEditPolicy;
...
import org.eclipse.gmf.examples.design2d.providers.DesignParserProvider;
 ...
 * @generated
 */
public class SolidLineCommentEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(DesignVisualIDRegistry.getType(org.eclipse.gmf.examples.design2d.edit.parts.SolidLineCommentEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public SolidLineCommentEditPart(View view) {
		super(view);
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof DesignTextSelectionEditPolicy) {
			((DesignTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new DesignParserProvider.HintAdapter(DesignElementTypes.Link_4001, getParserElement(), parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this), DesignEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
