 ...
 * @generated
 */
public class LargeItemWeightEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TaiPanParserProvider.getParser(TaiPanElementTypes.LargeItem_3002, getParserElement(),
					TaiPanVisualIDRegistry.getType(org.eclipse.gmf.examples.taipan.gmf.editor.edit.parts.LargeItemWeightEditPart.VISUAL_ID));
		}
		return parser;
	}
