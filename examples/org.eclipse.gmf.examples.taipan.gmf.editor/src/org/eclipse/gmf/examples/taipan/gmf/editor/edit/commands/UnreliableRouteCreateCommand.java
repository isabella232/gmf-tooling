 ...
 * @generated
 */
public class UnreliableRouteCreateCommand extends EditElementCommand {
	...
	public boolean canExecute() {
		...
		return TaiPanBaseItemSemanticEditPolicy.getLinkConstraints().canCreateRoute_4003(getContainer(), getSource(), getTarget());
	}
	...
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		ElementInitializers.getInstance().init_Route_4003(newElement);
