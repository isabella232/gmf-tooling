...
public class UnreliableRouteDescEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(TaiPanVisualIDRegistry.getType(org.eclipse.gmf.examples.taipan.gmf.editor.edit.parts.UnreliableRouteDescEditPart.VISUAL_ID), new Point(0, 40));
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TaiPanParserProvider.getParser(TaiPanElementTypes.Route_4003, getParserElement(),
					TaiPanVisualIDRegistry.getType(org.eclipse.gmf.examples.taipan.gmf.editor.edit.parts.UnreliableRouteDescEditPart.VISUAL_ID));
		}
		return parser;
	}
