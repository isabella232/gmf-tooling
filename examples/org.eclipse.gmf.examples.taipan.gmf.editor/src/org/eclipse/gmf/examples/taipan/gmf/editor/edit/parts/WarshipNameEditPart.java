 ...
 * @generated
 */
public class WarshipNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TaiPanParserProvider.getParser(TaiPanElementTypes.Warship_2003, getParserElement(),
					TaiPanVisualIDRegistry.getType(org.eclipse.gmf.examples.taipan.gmf.editor.edit.parts.WarshipNameEditPart.VISUAL_ID));
		}
		return parser;
	}
