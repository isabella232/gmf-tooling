 ...
 * @generated
 */
public class RouteReliabilityLinkLabelViewFactory extends AbstractLabelViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index,
		...
		annotation.getDetails().put("value", "4009");
		getViewService().createNode(semanticAdapter, view, TaiPanSemanticHints.Route_3002Labels.ROUTERELIABILITY_4009_TEXT,
