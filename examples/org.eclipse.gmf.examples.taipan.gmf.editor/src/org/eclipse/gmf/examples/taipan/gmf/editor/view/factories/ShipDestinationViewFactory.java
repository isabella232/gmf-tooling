...
public class ShipDestinationViewFactory extends ConnectionViewFactory {
	...
	protected void decorateView(View containerView, View view, IAdaptable semanticAdapter, String semanticHint, int index, boolean persisted) {
		if (semanticHint == null) {
			semanticHint = TaiPanVisualIDRegistry.getType(org.eclipse.gmf.examples.taipan.gmf.editor.edit.parts.ShipDestinationEditPart.VISUAL_ID);
		...
		getViewService().createNode(semanticAdapter, view, TaiPanVisualIDRegistry.getType(ShipDestinationLabelEditPart.VISUAL_ID), ViewUtil.APPEND, true, getPreferencesHint());
	}
}
