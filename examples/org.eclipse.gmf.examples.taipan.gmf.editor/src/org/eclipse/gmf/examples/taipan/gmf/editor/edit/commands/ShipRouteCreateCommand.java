...
public class ShipRouteCreateCommand extends EditElementCommand {
	 ...
	 * @generated
	 */
	public ShipRouteCreateCommand(CreateRelationshipRequest request, EObject source, EObject target) {
	...
	public boolean canExecute() {
		...
		if (target != null && false == target instanceof Route) {
			return false;
		}
		if (getSource() == null) {
