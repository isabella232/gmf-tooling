...
public class TaiPanElementTypes {
	...
	* @generated
	*/
	private static DiagramElementTypeImages elementTypeImages = new DiagramElementTypeImages(TaiPanDiagramEditorPlugin.getInstance().getItemProvidersAdapterFactory());
