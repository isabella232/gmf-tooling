...
public class ReliableRouteRelbEditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	 ...
	 */
	static {
		registerSnapBackPosition(TaiPanVisualIDRegistry.getType(org.eclipse.gmf.examples.taipan.gmf.editor.edit.parts.ReliableRouteRelbEditPart.VISUAL_ID), new Point(0, 60));
	}
	...
	*/
	...
	public IParser getParser() {
		if (parser == null) {
			parser = TaiPanParserProvider.getParser(TaiPanElementTypes.Route_4002, getParserElement(),
					TaiPanVisualIDRegistry.getType(org.eclipse.gmf.examples.taipan.gmf.editor.edit.parts.ReliableRouteRelbEditPart.VISUAL_ID));
		}
		return parser;
	}
