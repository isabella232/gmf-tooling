 ...
 * @generated
 */
public class ShipNodeItemSemanticEditPolicy extends ItemSemanticEditPolicy {
	...
	protected Command getCreateRelationshipCommand(CreateRelationshipRequest req) {
		if (ElementTypes.ShipDestination_3001 == req.getElementType()) {
			return req.getTarget() == null ? getCreateStartOutgoingShip_Destination3001Command(req) : getCreateCompleteOutgoingShip_Destination3001Command(req);
		}
