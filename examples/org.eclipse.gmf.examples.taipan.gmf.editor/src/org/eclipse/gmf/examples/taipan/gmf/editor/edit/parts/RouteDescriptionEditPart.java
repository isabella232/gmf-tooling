 ...
 * @generated
 */
public class RouteDescriptionEditPart extends LabelEditPart implements ITextAwareEditPart {
	 ...
	 */
	static {
		registerSnapBackPosition(TaiPanVisualIDRegistry.getType(RouteDescriptionEditPart.VISUAL_ID), new Point(0, 40));
	}

	/**
	 * @generated
	 */
	public RouteDescriptionEditPart(View view) {
		super(view);
	}
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager.getTextCellEditorClass(this),
					TaiPanEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
	...
	protected void refreshFont() {
		FontStyle style = (FontStyle) getFontStyleOwnerView().getStyle(
				NotationPackage.eINSTANCE.getFontStyle());
		if (style != null) {
			FontData fontData = new FontData(style.getFontName(), style.getFontHeight(), (style.isBold() ? org.eclipse.swt.SWT.BOLD
