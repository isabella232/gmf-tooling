...
public class TaiPanCreateShortcutAction implements IObjectActionDelegate {
	...
	public void run(IAction action) {
		...
		try {
			...
			TaiPanDiagramEditorPlugin.getInstance().logError("Exception while loading object: " + selectedModelElementURI.toString(), e); //$NON-NLS-1$
			return;
		}
		...
		CreateViewRequest.ViewDescriptor viewDescriptor = new CreateViewRequest.ViewDescriptor(new EObjectAdapter(selectedElement), TaiPanDiagramEditorPlugin.DIAGRAM_PREFERENCES_HINT);
