 ...
 * @generated
 */
public class SmallItemsEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new SmallItemsItemSemanticEditPolicy());
				...
				ParserHintAdapter hintAdapter = new ParserHintAdapter(element, parserHint) {
					...
					public Object getAdapter(Class adapter) {
						if (IElementType.class.equals(adapter)) {
							return TaiPanElementTypes.SmallItems_2001;
						}
