 ...
 * @generated
 */
public class OneContainmentGroupNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public OneContainmentGroupNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LesscodeParserProvider.getParser(LesscodeElementTypes.OneContainmentGroup_2002, getParserElement(),
					LesscodeVisualIDRegistry.getType(org.eclipse.gmf.example.lesscode.diagram.edit.parts.OneContainmentGroupNameEditPart.VISUAL_ID));
		}
		return parser;
	}
