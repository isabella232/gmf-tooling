 ...
 * @generated
 */
public class MultiContainmentGroupNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public MultiContainmentGroupNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new LesscodeTextSelectionEditPolicy());
		installEditPolicy(EditPolicy.DIRECT_EDIT_ROLE, new LabelDirectEditPolicy());
		installEditPolicy(EditPolicy.PRIMARY_DRAG_ROLE, new RootContainerEditPart.NodeLabelDragPolicy());
	}
	...
	*/
	protected Image getLabelIcon() {
		...
		return LesscodeElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LesscodeParserProvider.getParser(LesscodeElementTypes.MultiContainmentGroup_2003, getParserElement(),
					LesscodeVisualIDRegistry.getType(org.eclipse.gmf.example.lesscode.diagram.edit.parts.MultiContainmentGroupNameEditPart.VISUAL_ID));
		}
		return parser;
	}
	...
	*/
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager2(this, null, LesscodeEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
