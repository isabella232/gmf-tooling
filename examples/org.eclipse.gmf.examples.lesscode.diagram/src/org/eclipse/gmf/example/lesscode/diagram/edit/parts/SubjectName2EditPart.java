 ...
 * @generated
 */
public class SubjectName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SubjectName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LesscodeParserProvider.getParser(LesscodeElementTypes.Subject_3001, getParserElement(),
					LesscodeVisualIDRegistry.getType(org.eclipse.gmf.example.lesscode.diagram.edit.parts.SubjectName2EditPart.VISUAL_ID));
		}
		return parser;
	}
