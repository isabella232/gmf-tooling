 ...
 * @generated
 */
public class SubjectName3EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SubjectName3EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = LesscodeParserProvider.getParser(LesscodeElementTypes.Subject_3002, getParserElement(),
					LesscodeVisualIDRegistry.getType(org.eclipse.gmf.example.lesscode.diagram.edit.parts.SubjectName3EditPart.VISUAL_ID));
		}
		return parser;
	}
