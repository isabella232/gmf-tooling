...
public class LesscodeParserProvider extends AbstractProvider implements IParserProvider {
	...
	* @generated
	*/
	private IParser subjectName_5001Parser;

	/**
	* @generated
	*/
	private IParser getSubjectName_5001Parser() {
		if (subjectName_5001Parser == null) {
			EAttribute[] features = new EAttribute[] { LesscodePackage.eINSTANCE.getWithSomeAttributes_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			subjectName_5001Parser = parser;
		}
		return subjectName_5001Parser;
	}

	/**
	* @generated
	*/
	private IParser subjectName_5003Parser;

	/**
	* @generated
	*/
	private IParser getSubjectName_5003Parser() {
		if (subjectName_5003Parser == null) {
			EAttribute[] features = new EAttribute[] { LesscodePackage.eINSTANCE.getWithSomeAttributes_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			subjectName_5003Parser = parser;
		}
		return subjectName_5003Parser;
	}

	/**
	* @generated
	*/
	private IParser subjectName_5005Parser;

	/**
	* @generated
	*/
	private IParser getSubjectName_5005Parser() {
		if (subjectName_5005Parser == null) {
			EAttribute[] features = new EAttribute[] { LesscodePackage.eINSTANCE.getWithSomeAttributes_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			subjectName_5005Parser = parser;
		}
		return subjectName_5005Parser;
	}

	/**
	* @generated
	*/
	private IParser subjectName_5006Parser;

	/**
	* @generated
	*/
	private IParser getSubjectName_5006Parser() {
		if (subjectName_5006Parser == null) {
			EAttribute[] features = new EAttribute[] { LesscodePackage.eINSTANCE.getWithSomeAttributes_Name() };
			MessageFormatParser parser = new MessageFormatParser(features);
			subjectName_5006Parser = parser;
		}
		return subjectName_5006Parser;
	}
	...
	*/
	protected IParser getParser(int visualID) {
		...
		case SubjectName2EditPart.VISUAL_ID:
			return getSubjectName_5001Parser();
		case SubjectName3EditPart.VISUAL_ID:
			return getSubjectName_5003Parser();
		case SubjectName4EditPart.VISUAL_ID:
			return getSubjectName_5005Parser();
		case SubjectName5EditPart.VISUAL_ID:
			return getSubjectName_5006Parser();
		}
		return null;
	}
