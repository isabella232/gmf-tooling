 ...
 * @generated
 */
public class MultiContainmentGroupInGroupManyCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected Set getFeaturesToSynchronize() {
		if (myFeaturesToSynchronize == null) {
			...
			myFeaturesToSynchronize.add(LesscodePackage.eINSTANCE.getMultiContainmentGroup_SubjectsTypeA());
			myFeaturesToSynchronize.add(LesscodePackage.eINSTANCE.getMultiContainmentGroup_SubjectsTypeB());
		}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<LesscodeNodeDescriptor> childDescriptors = LesscodeDiagramUpdater.getMultiContainmentGroupInGroupMany_7005SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == Subject4EditPart.VISUAL_ID || visualID == Subject5EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<LesscodeNodeDescriptor> childDescriptors = LesscodeDiagramUpdater.getMultiContainmentGroupInGroupMany_7005SemanticChildren((View) getHost().getModel());
		...
		HashMap<LesscodeNodeDescriptor, LinkedList<View>> potentialViews = new HashMap<LesscodeNodeDescriptor, LinkedList<View>>();
		//
