...
public class TaiPanActionBarContributor extends EditingDomainActionBarContributor implements ISelectionChangedListener {
	 ...
	 * @generated
	 */
	protected IAction showPropertiesViewAction = new Action(TaiPanEditPlugin.INSTANCE.getString("_UI_ShowPropertiesView_menu_item")) {
	 ...
	 * @generated
	 */
	protected IAction refreshViewerAction = new Action(TaiPanEditPlugin.INSTANCE.getString("_UI_RefreshViewer_menu_item")) {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("taipan-settings"));
		toolBarManager.add(new Separator("taipan-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(TaiPanEditPlugin.INSTANCE.getString("_UI_TaiPanEditor_menu"), "org.eclipse.gmf.examples.taipanMenuID");
		...
		//
		createChildMenuManager = new MenuManager(TaiPanEditPlugin.INSTANCE.getString("_UI_CreateChild_menu_item"));
		submenuManager.insertBefore("additions", createChildMenuManager);

		// Prepare for CreateSibling item addition or removal.
		//
		createSiblingMenuManager = new MenuManager(TaiPanEditPlugin.INSTANCE.getString("_UI_CreateSibling_menu_item"));
